            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{FINANCIAL_YEAR_END_URL}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                            <fieldset>
                                <!-- Message body -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="opening_stock_depot1"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="opening_stock_depot2"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="opening_stock_depot3"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="closing_stock_depot1"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="closing_stock_depot2"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="closing_stock_depot3"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="npa_amount"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="npa_int"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_payble_fd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_payble_rd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_recover_loan"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_recover_bank_fd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_recover_bank_rd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="net_profit"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="net_loss"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)">
