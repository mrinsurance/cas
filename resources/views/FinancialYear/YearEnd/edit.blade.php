            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{FINANCIAL_YEAR_END_URL.'/'.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                      {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                    ...
                                    <div class="col-md-7">
                                       <select name="financial_year" class="form-control" required>
                                        ...
                                        @foreach($session_years as $list)
                                            <option value="{{$list->id}}" {{$list->id == $item->session_master_model_id ? 'selected' : ''}}>{{date('Y', strtotime($list->start_date))}} - {{date('Y', strtotime($list->end_date))}}</option>
                                        @endforeach    
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="opening_stock_depot1"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->opening_stock_depot1}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="opening_stock_depot2"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->opening_stock_depot2}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="opening_stock_depot3"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->opening_stock_depot3}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="closing_stock_depot1"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->closing_stock_depot1}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                       <input type="text" name="closing_stock_depot2"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->closing_stock_depot2}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="closing_stock_depot3"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->closing_stock_depot3}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="npa_amount"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->npa_amount}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="npa_int"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->npa_int}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_payble_fd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->int_payble_fd}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_payble_rd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->int_payble_rd}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_recover_loan"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->int_recover_loan}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_recover_bank_fd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->int_recover_bank_fd}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="int_recover_bank_rd"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->int_recover_bank_rd}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="net_profit"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->net_profit}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                         <input type="text" name="net_loss"  class="form-control col-md-7 col-xs-12"  onkeypress="return isNumAndDecimalKey(event)" value="{{$item->net_loss}}">
