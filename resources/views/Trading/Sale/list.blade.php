                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{TRADING_URL_SALE}}/create"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                        @endcan
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr id="product{{$item->id}}">
                                    <td>{{$loop->index + 1}}</td>
                                    <td>
                                      <a href="{{TRADING_URL_SALE.'/'.$item->id}}/edit" title="Edit"><i class="fa fa-edit text-danger"></i></a>
                                      <a href="{{TRADING_URL_SALE.'/'.$item->id}}" title="View"><i class="fa fa-eye text-success"></i></a>
                                      <a href="{{ route('trading.sale.print','id='.$item->id) }}" title="Print" target="_blank"><i class="fa fa-print text-primary"></i></a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> {{ $amount }}</td>
                                    <td>{{$item->client}}</td>
                                    <td>{{$item->sale_by}}</td>
                                  </tr>
                                @endforeach
