                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{TRADING_URL_PRODUCTS}}/create"><i class="fa fa-plus-circle"></i> Add New</a>
                        </div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                   @foreach($items as $item)
                                      <tr id="product{{$item->id}}">
                                        ...
                                        <td>{{@$item->tax_master_tbl->name}}</td>
                                        <td>{{@$item->product_type_master_tbl->name}}</td>
                                        <td>
                                            <a href="{{TRADING_URL_PRODUCTS.'/'.$item->id.'/edit'}}" title="Edit"  class="btn btn-success">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger delete-product" value="{{TRADING_URL_PRODUCTS.'/'.$item->id}}" title="Delete"><i class="fa fa-trash"></i> </button>
