            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRADING_URL_PRODUCTS.'/'.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
  {{csrf_field()}}
  {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="text" name="hsn" class="form-control col-md-7 col-xs-12" value="{{$item->hsn}}">
