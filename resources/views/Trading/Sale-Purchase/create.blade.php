                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <select name="sale_to" class="form-control" required="">
                                        ...
                                        <option value="{{$list->name}}" {{request()->st == $list->name ? 'selected' : ''}}>{{$list->name}}</option>
                                        @endforeach
                                      </select>
                             ...
                             <!-- Form Group  For head entry -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <input type="text" name="quantity" class="form-control text-right" placeholder="Quantity" id="quantity_id" onkeyup="saleCalculateRate();">
