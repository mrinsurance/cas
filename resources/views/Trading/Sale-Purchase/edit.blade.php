                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRADING_URL_SALE.'/'.$item->id}}" id="post_frm" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                             ...
                             <!-- Form Group  For head entry -->
                                <div class="form-group">
                                    <div class="col-md-2">
                                      <span class="text-dark">Product Name</span>
                                        <select name="product_name" class="form-control" id="product_name" required="">
                                          <option value="">--- Select ---</option>
                                          @foreach($productMasterList as $list)
                                    ...
                                    <div class="col-md-1">
                                      ...
                                      <input type="text" name="rate" class="form-control text-right" placeholder="Rate" id="rate_id" onkeyup="saleCalculateRate();">
                                    ...
                                    <div class="col-md-2 text-right">
                                      <button type="submit" class="btn btn-success btn_sizes"> <i class="fa fa-plus"></i> Add New</button>
                                    </div>                                    
                            </div>
                          </div>
                      </div>
                  ...
                  <div class="row mb-10">
                      <div class="col-md-12 text-center">
                        ...
                        <input type="hidden" name="item_id" value="{{$item->id}}">
                            <button type="submit" class="btn btn-danger btn_sizes">Approved</button>
                        </form>
                      </div>
                  </div>
                  @endif
