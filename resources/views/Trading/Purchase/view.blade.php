                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($purchaseDetail->sum('sgst'),2)}}</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($purchaseDetail->sum('cgst'),2)}}</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($purchaseDetail->sum('amount'),2)}}</strong></td>
