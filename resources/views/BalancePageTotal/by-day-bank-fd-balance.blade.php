        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{BALANCE_REPORT_URL_BANK_FD_BY_DAY}}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-3">
                    ...
                    <div class="table-scrollable">
                        ...
                        <div class="prnt" id="record">
                           ...
                           <table class="table table-bordered table-hover" id="mytable_css">
                            <thead>
                                <tr>
                                    <td colspan="{{isset(request()->bank) ? 8 : 9}}">
...
@endif
@endforeach
                                                Bank FD Balance Report as on {{date('d-M-Y',strtotime($from_date))}}
                                            </h4>    
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <th>#</th>
                                    <th class="{{isset(request()->bank) ? 'hide' : ''}}">Bank Name</th>
                                    <th>A/C No.</th>
                                    <th>FD No.</th>
                                    <th>FD Dated</th>
                                    <th>FD Amount</th>
...
@endphp
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"> <i class="fa fa-inr"></i> {{number_format($intr,2)}}</td>
                                    <td class="align_right">{{date('d/m/Y',strtotime($item->maturity_date))}}</td>
                                    <td class="align_right"><i class="fa fa-inr"></i> {{number_format($item->maturity_amount,2)}}</td>
                                </tr>
                                @php
                                ...
                                @endforeach
                                <tr>
                                    <th colspan="{{isset(request()->bank) ? 4 : 5}}">Total</th>
                                    ...
                                    <th></th>
                                    <th class="align_right"><i class="fa fa-inr"></i> {{number_format($MatAmt,2)}}</th>
                                </tr>
                            </tbody>
                        </table>
                        </div>
