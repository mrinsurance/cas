        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{ route('balance.report.page.total.balance.book') }}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-3">
...
{{--                            <a href="javascript:void(0);" onclick="$('#form-pdf').submit()" class="btn btn-info">Download PDF</a>--}}
                        </div>
                    </form>
{{--                        <form action="{{ route('balance-report.balance-book.download-pdf',['from_date'=>request()->get('from_date'),'member_type'=>request()->get('member_type')]) }}" id="form-pdf" method="post">@csrf</form>--}}
                    </div>
                    </div>
        ...
        $tintr = 0;
                                ...
                                @if(count($ac_holders) > 32)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align_right"><strong>{{number_format(0,2,'.','')}}</strong></td>
                                        <td class="align_right"><strong>{{number_format(0,2,'.','')}}</strong></td>
                                        <td></td>
                                        <td class="align_right"><strong>{{number_format(0,2,'.','')}}</strong></td>
                                        <td class="align_right"><strong>{{number_format(0,2,'.','')}}</strong></td>
