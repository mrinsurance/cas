        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{BALANCE_REPORT_URL_DRD}}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-3">
...
@endif
@endforeach                                                
                                                DRD Balance Report as on {{date('d-M-Y',strtotime($from_date))}}
                                            </h4>    
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> {{number_format($totall,2)}}</td>
