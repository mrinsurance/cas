                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box primary">
                        ...
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" action="{{ route('balance.report.page.total.balance.rd') }}" method="get">
                                        {{csrf_field()}}
                                        <div class="col-md-3">
                                        ...
                                        @foreach($items as $item)
                                            ...
                                            @if($srn == 32)
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align_right"> <strong>{{number_format($pageTotalFd,2,'.','')}}</strong></td>
                                                    @if(request()->wp == FALSE)
                                                        <td class="align_right"> <strong>{{number_format($pageTotalPayInt,2,'.','')}}</strong></td>
                                                    @endif
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5"><strong>Grand Total</strong></td>
                                                    <td class="align_right"> <strong>{{number_format($grandTotalFd,2,'.','')}}</strong></td>
                                                    @if(request()->wp == FALSE)
                                                        <td class="align_right"> <strong>{{number_format($grandTotalPayInt,2,'.','')}}</strong></td>
                                                    @endif
                                                    <td></td>
                                                </tr>
                                                @if(count($items) > $trec)
