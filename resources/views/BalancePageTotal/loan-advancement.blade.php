        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="{{ route('balance.report.page.total.loan-advancement') }}" method="get">
                        {{csrf_field()}}
                    <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                            ...
                            @foreach($_loanReport as $_loan)
                                ...
                                @if($srn == 24)
                                    ...
                                    <tr>
                                        ...
                                        <td class="align_right"><strong>{{number_format($pageTotal,2,'.','')}}</strong></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5"><strong>Grand Total</strong></td>
                                        <td class="align_right"><strong>{{number_format($grandTotal,2,'.','')}}</strong></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    @if(count($_loanReport) > $trec)
                                        <tr>
                                            <td colspan="5"><strong>Previous Total</strong></td>
                                            <td class="align_right"><strong>{{number_format($grandTotal,2,'.','')}}</strong></td>
                                            <td></td>
                                ...
                                @else
                                    @if(count($_loanReport) == $trec)
                                        ...
                                        <tr>
                                            <td colspan="5"><strong>Grand Total</strong></td>
                                            <td class="align_right"><strong>{{number_format($_loanTotal,2,'.','')}}</strong></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                    @endif
