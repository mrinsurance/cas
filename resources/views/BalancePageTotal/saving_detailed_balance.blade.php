                                ...
                                <div class="prnt" id="record">
                                    ...
                                    <table class="table table-bordered table-hover" id="mytable_css">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align_right"><i class="fa fa-inr"></i>{{@number_format($sum_divident_paid,2)}}</td>

                                            <td class="align_right"><i class="fa fa-inr"></i>{{@number_format($sum_interest_paid,2)}}</td>
                                            <td class="align_right">
                                                <i class="fa fa-inr"></i>
