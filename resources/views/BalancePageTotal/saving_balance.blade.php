                    ...
                    <div class="portlet box primary">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <a href="{{url('balance-report/saving-paginate')}}" class="btn btn-success btn_sizes pull-right">Paginate View</a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" action="{{BALANCE_REPORT_URL_SAVING}}" method="get">
                                        {{csrf_field()}}
                                        <div class="col-md-3">
