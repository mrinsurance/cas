        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="{{D_BALANCE_REPORT_URL_LOAN_DEFAULTER}}" method="get">
                        {{csrf_field()}}
                    <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <select name="ward" class="form-control">
                                    ...
                                    @foreach($userWard as $ward)
                                        <option value="{{$ward->ward}}" {{$ward->ward == request()->ward ? 'selected' : ''}}>{{$ward->ward}}</option>
                                    @endforeach
...
@endif
@endforeach
                                     Loan Defaulter List For {{$defaulter_year}} Year as on {{date('d-M-Y',strtotime($from_date))}}
                                            </h4>    
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                @if(request()->ward == true && @$item->open_new_ac_model->ward == request()->ward)
                                @php
...
@endphp                         
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> {{($item->amount - $tbl_loan_return_model_sum->total_received_principal)}}</td>
                                    <td class="align_right">{{date('d/m/Y',strtotime($item->date_of_advance))}}</td>
                                    <td class="align_right">{{date('d/m/Y',strtotime($_rdate))}}</td>
                                    <td>
                                        @php
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> {{$tintr}}</td>
                                </tr>
                                @php 
...
@endphp                         
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{$total_of_balance}}</strong></td>
                                    <td></td>
                                    <td></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{$total_recover_int}}</strong></td>
                                </tr>
                            </tbody>
                        </table>
                        </div>
