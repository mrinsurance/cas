...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Saving Balance</li>
        </ol>
    </section>
    <!--section ends-->
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="list" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Balance Report of Saving A/C
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{url('balance-report/saving-paginate')}}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-3">
...
@endif
@endforeach                                                
                                                Saving Balance Report as on {{date('d-M-Y',strtotime($from_date))}}
                                            </h4>    
                                        </div>
                                    </td>
                                </tr>
                        ...
                        @if(isset($_REQUEST['_token']))
                                <div style="float: right;margin-right:10px">{{ @($_REQUEST['from_date'])?$ac_holders->appends(['_token' => $_REQUEST['_token'],'branch' => $_REQUEST['branch'],'from_date' => $_REQUEST['from_date'],'member_type' => $_REQUEST['member_type'],'paginate_total_grand'=>@$paginate_total_grand])->render():'' }}</div>
                         @endif
                    </div>
                </div>
            </div>
