        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="{{D_BALANCE_REPORT_URL_SHARE}}" method="get">
                    <div class="row">
                    <div class="col-md-12">
                        {{csrf_field()}}
                        <div class="col-md-6">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <h4>
                                                Member Share Balance Report from <strong>{{date('d-M-Y',strtotime($from_date))}}</strong> to <strong> {{date('d-M-Y',strtotime($to_date))}}</strong>
                                            </h4>    
                                        </div>
                                    </td>
                                </tr>
