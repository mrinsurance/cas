        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{ route('balance.book.list') }}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-3">
    ...
    $tintr = 0;
                              ...
                              $status_data =  DB::table('balance_book_status')->where(['session_id'=>@$_REQUEST['session_year'],'ac_holder_id'=>$val->id])->first();
                                ...
                                <tr>
                                    ...
                                    <td class="align_right">{{number_format($share_balance,2,'.','')}}</td>
                                    ...
                                    <td class="align_right">{{number_format($saving_balance,2,'.','')}}</td>
                                </tr>
                                @endif
                                @php
                                $share_page_total = 0;
                                ...
                                $srn = 0; @endphp
                                    ...
                                    <td class="align_right"><strong>{{number_format($share_page_total,2,'.','')}}</strong></td>
                                    <td class="align_right"><strong>{{number_format($loan_page_total,2,'.','')}}</strong></td>
                                    <td></td>
                                    <td class="align_right"><strong>{{number_format($loan_intr_page_total,2,'.','')}}</strong></td>
                                    <td class="align_right"><strong>{{number_format($saving_page_total,2,'.','')}}</strong></td>
                                    </tr>
                                    <tr>
                                    <td colspan="3"><strong>Grand Total</strong></td>
                                    <td class="align_right"><strong>{{number_format($share_grand_total,2,'.','')}}</strong></td>
                                    <td class="align_right"><strong>{{number_format($loan_grand_total,2,'.','')}}</strong></td>
                                    <td></td>
                                    <td class="align_right"><strong>{{number_format($loan_intr_grand_total,2,'.','')}}</strong></td>
                                    <td class="align_right"><strong>{{number_format($saving_grand_total,2,'.','')}}</strong></td>
                                    </tr>
                                    @endif
