        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{ route('setting.rd-second') }}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-3">
...
$maturity_amount = round($matured_amount);
                                ...
                                <tr>
                                    ...
                                    <td class="align_right">{{ $item->period_rd ?? 0 }}</td>
                                    <td class="align_right">{{ $item->int_rate ?? 0 }}</td>
                                    <td class="align_right">{{ $item->maturity_amount ?? 0 }}</td>
