...
<aside class="right-side strech">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="doc-portrait" data-c="#fff" data-hc="#fff" data-size="18" data-loop="true"></i> Show Role
                        </h3>
                    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <a href="{{ROLES}}" class="btn btn-warning btn_sizes">Back</a>
        </div>
    </div>                        
                    </div>
                </div>
