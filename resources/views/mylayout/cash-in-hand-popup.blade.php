        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="row">
                    ...
                    <div class="col-12">
                        <form class="form-horizontal" id="searchDailyCash" action="{{ route('search.daily.cash.coin') }}" method="post">
                            @csrf
                            <fieldset>
                                <!-- Name input-->
                                <!-- Email input-->
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" id="searchDailyCashUpdate" action="{{ route('search.daily.cash.coin.update') }}" method="post">
                    @csrf
