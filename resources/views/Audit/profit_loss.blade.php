        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{AUDIT_REPORT_URL_PROFIT_LOSS}}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-2">                            
                            <span class="text-dark">From</span>
                            <input type="date" class="form-control" value="{{date('Y-m-d')}}" name="from_date" required>                           
                        </div>
                        <div class="col-md-2">
                            <span class="text-dark">To</span>
                            <input type="date" class="form-control" value="{{date('Y-m-d')}}" name="to_date" required>
                        </div>
                        <div class="col-md-2">
