        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{AUDIT_REPORT_URL_TRIAL_BALANCE}}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-2">
                            <span>From</span>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <h4>
                                Trial Balance Report From  {{date('d-M-Y',strtotime($from_date))}}
                                to 
...
@endphp                                
                                <tr>
                                    <td>{{$i++}}</td>
                                    <td>{{strtoupper($mainHead->main_head)}}</td>
                                    <td class="align_right">
                                        <i class="fa fa-inr"></i>
                                        @if($openingBalance > 0)
                                            {{number_format($openingBalance,2)}} <strong>Dr</strong>
                                        @elseif($openingBalance < 0)
                                            {{number_format(($openingBalance * -1),2)}} <strong>Cr</strong>
                                        @else
                                        0.00 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   
                                        @endif 
                                        </td>
                                    <td class="align_right"><i class="fa fa-inr"></i> {{number_format($crSum,2)}}</td>
                                    <td class="align_right"><i class="fa fa-inr"></i> {{number_format($drSum,2)}}</td>
                                    <td class="align_right">
                                        <i class="fa fa-inr"></i>
                                        @if($balance < 0)
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>0.00</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($closing,2)}}</strong></td>
                                    <td>&nbsp;</td>
                                     <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($closing,2)}}</strong></td>
                                </tr>                                
                                <tr>
                                    <td colspan="3"><strong>Total:</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($totalCr + $opening,2)}}</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($totalDr + $closing,2)}}</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format($balcr,2)}}</strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong>{{number_format(($baldr + $closing),2)}}</strong></td>
