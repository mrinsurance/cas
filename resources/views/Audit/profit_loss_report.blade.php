        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{ route('audit.report.profit.loss') }}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-2">
                        ...
                        <!-- Print view                         -->
                           ...
                           <table width="60%" class="table table-bordered table-hover" id="mytable_css">
                            ...
                            <tbody>
                                        ...
                                        <table width="60%"  class="table table-bordered table-hover" id="mytable_css">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td class="text-right">{{number_format($plmHeadAmt,2,'.','')}}</td>
                                                </tr>
                                                @endif
                                                @endforeach
                                               ...
                                               <tr>
                                                    ...
                                                    <td class="text-right">{{number_format($intrLoan,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($intrBankFd > 0)
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{number_format($intrBankFd,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($intrBankRd > 0)
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{number_format($intrBankRd,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($lbsplcrTotal > 0)
                                                <tr>
                                                    ...
                                                    <td class="text-right">-{{number_format($lbspldrTotal,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($intrRec > 0)
                                                <tr>
                                                    ...
                                                    <td>&nbsp;</td>
                                                    <td class="text-right">{{number_format(($intrRec),2,'.','')}}</td>
                                                </tr>
                                                @endif
                                                @if($lbsNpa > 0)
                                                <tr>
                                                    <td>NPA LBS</td>
                                                    <td>&nbsp;</td>
                                                    <td class="text-right">{{number_format($lbsNpa,2,'.','')}}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{number_format(($pldrTotal - $plcrTotal),2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                        ...
                                        <table  class="table table-bordered table-hover" id="mytable_css">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{number_format($intrFd,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($intrRd > 0)
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{number_format($intrRd,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($lbspldrTotal > 0)
                                                <tr>
                                                    <td>{{("INTEREST PAYBLE LBS")}}</td>
                                                    <td class="text-right">-{{number_format($lbsplcrTotal,2,'.','')}}</td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                @endif
                                                @if($intrPaid > 0)
                                                <tr>
                                                    ...
                                                    <td>&nbsp;</td>
                                                    <td class="text-right">{{number_format(($intrPaid),2,'.','')}}</td>
                                                </tr>
                                                @endif
                                                @if($npaAmt > 0)
                                                <tr>
                                                    <td>NPA AMOUNT</td>
                                                    <td>&nbsp;</td>
                                                    <td class="text-right">{{number_format($npaAmt,2,'.','')}}</td>
                                                </tr>
                                                @endif
                                                @if($npaIntr > 0)
                                                <tr>
                                                    <td>NPA INTEREST</td>
                                                    <td>&nbsp;</td>
                                                    <td class="text-right">{{number_format($npaIntr,2,'.','')}}</td>
                                                </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&nbsp;</td>
                                                    <td class="text-right">{{number_format(($plcrTotal - $pldrTotal),2,'.','')}}</td>
                                                </tr>
                                                @endif
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    @if($pldrTotal > $plcrTotal)
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> {{number_format($plcrTotal + ($pldrTotal - $plcrTotal),2,'.','')}}</td>
                                    @else
                                        <td class="text-right"  colspan="2"><strong class="ml-55">TOTAL:</strong> {{number_format($plcrTotal,2,'.','')}}</td>
                                    @endif

                                    @if($plcrTotal > $pldrTotal)
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> {{number_format($pldrTotal + ($plcrTotal - $pldrTotal),2,'.','')}}</td>
                                    @else
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> {{number_format($pldrTotal,2,'.','')}}</td>
                                    @endif
                                </tr>
                            </tbody>
                        </table>
