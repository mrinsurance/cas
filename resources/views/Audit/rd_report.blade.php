        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="{{AUDIT_REPORT_URL_RD}}" method="get">
                        {{csrf_field()}}
                        <div class="col-md-2">
                            <span>From</span>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <h4>
                                Receipt & Disbursement Report from  {{date('d-M-Y',strtotime($from_date))}}
                                to 
...
@endphp                                
                                <tr>
                                    ...
                                    <td class="align_right"> {{number_format($crSum,2,'.','')}}</td>
                                    <td class="align_right"> {{number_format($drSum,2,'.','')}}</td>
                                </tr>
@php 
    $totalDr += $drSum;
    $totalCr += $crSum;
@endphp
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"> <strong>{{number_format($opening,2,'.','')}}</strong></td>
                                    <td class="align_right"> <strong>0.00</strong></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><strong>Closing Cash In Hand:</strong></td>
                                    <td class="align_right"> <strong>0.00</strong></td>
                                    <td class="align_right"> <strong>{{number_format($closing,2,'.','')}}</strong></td>
                                </tr>                                
                                <tr>
                                    <td colspan="2"><strong>Total:</strong></td>
                                    <td class="align_right"> <strong>{{number_format($totalCr + $opening,2,'.','')}}</strong></td>
                                    <td class="align_right"> <strong>{{number_format($totalDr + $closing,2,'.','')}}</strong></td>
                                </tr>
