        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="{{AUDIT_REPORT_URL_LOAN_ADVANCEMENT}}" method="get">
                        {{csrf_field()}}
                    <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                           ...
                           <table class="table table-bordered table-hover" id="mytable_css">
                            ...
                            @foreach($_loanReport as $_loan)
                                <tr>
                                    ...
                                    <td class="align_right">{{number_format($_loan->amount)}}</td>
                                    <td>
                                        @php
                            ...
                            @endforeach
                                <tr>
                                    ...
                                    <td class="align_right"><strong>{{number_format($_loanTotal)}}</strong></td>
                                    <td colspan="3" >&nbsp;</td>
                                </tr>
                            </tbody>
                        </table>
