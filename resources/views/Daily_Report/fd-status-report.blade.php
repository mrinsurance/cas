                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box primary">
                        ...
                        <div class="portlet-body">
                            <form class="form-horizontal" action="{{ route('daily.report.fd.status.report') }}" method="get">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="deposit_type" class="form-control">
                                                ...
                                                @foreach($type_of_deposite as $val)
                                                    <option value="{{$val}}" {{request()->get('deposit_type') == $val ? 'selected' : ''}}>{{$val}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                                ...
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <h4>
                                                        @foreach($members as $val)
                                                            ...
                                                            @endif
                                                        @endforeach
                                                        FD {{ request()->get('report') }} Report from {{ \Carbon\Carbon::parse(request()->get('fromDate'))->format('d-M-Y') }}
