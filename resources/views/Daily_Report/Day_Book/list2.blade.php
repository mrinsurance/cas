        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('daily.report.cash.book.combine')  }}" method="get">
                        {{csrf_field()}}
                        <fieldset>
                            <!-- Name input-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="from_date" class="form-control"  value="{{ request()->get('from_date') ? request()->get('from_date') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" name="to_date" class="form-control" value="{{ request()->get('from_date') ? request()->get('to_date') : \Carbon\Carbon::now()->format('Y-m-d') }}">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-md-12 text-left">
                                            ...
                                            <a href="{{ route('daily.report.day.book.print',['from_date'=>request()->get('from_date'), 'to_date'=>request()->get('to_date')]) }}" target="_blank" class="btn btn-success btn_sizes"><i class="fa fa-fw fa-print"></i> Print</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
