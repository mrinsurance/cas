                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="list-ul" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Users Management
                        </h3>
                        @can('product-create')
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{USERS}}/create"><i class="fa fa-plus-circle"></i> Create New User</a>
                        </div>
                        @endcan
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr id="product{{$item->id}}">
                                    ...
                                    <td>
                                      @can('product-list')  
                                      <a href="{{USERS.'/'.$item->id}}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View</a>
                                      @endcan

                                      @can('product-edit')
                                      <a href="{{USERS.'/'.$item->id}}/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                      @endcan

                                      @can('product-delete')
                                      <button type="button" class="btn btn-danger btn-sm delete-product" value="{{USERS.'/'.$item->id}}"><i class="fa fa-trash"></i> Delete</button>
