                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user" data-c="#fff" data-hc="#fff" data-size="18" data-loop="true"></i> Create New User
                                </h3>
...
<!-- From Group -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <!-- <input type="text" name="date_of_birth" class="form-control" id="dob" placeholder="yyyy-mm-dd" readonly> -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="aadhar_number" class="form-control" maxlength="12" placeholder="Aadhar Number">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="pan_number" class="form-control" maxlength="10" placeholder="PAN Number">
                                            </div>
                                        </div>
                                        <!-- From Group -->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" name="mobile" class="form-control" maxlength="10" placeholder="Mobile">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 180px; height: 130px;"></div>
                                        <div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                              <input type="text" name="mailing_address" class="form-control" placeholder="Address Line 1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="mailing_pin" class="form-control" placeholder="Pin" maxlength="6">
                    ...
                    <div class="form-group permanent_address">
                        ...
                        <div class="col-md-8">
                          <input type="text" name="permanent_address" class="form-control" placeholder="Address Line 2">
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group permanent_city">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="permanent_city" class="form-control" placeholder="City">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text" class="control-label col-md-4">Pin: </label>
                        <div class="col-md-8">
                            <input type="text" name="permanent_pin" class="form-control" placeholder="Pin" maxlength="6">
                        </div>
                    </div>  
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="pay_scale" class="form-control" placeholder="Pay Scale">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text" class="control-label col-md-4">Pay Band: </label>
                        <div class="col-md-8">
                            <input type="text" name="pay_band" class="form-control" placeholder="Pay Band">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text" class="control-label col-md-4">Grade Pay: </label>
                        <div class="col-md-8">
                            <input type="text" name="grade_pay" class="form-control" placeholder="Grade Pay">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text" class="control-label col-md-4">Current Basic: </label>
                        <div class="col-md-8">
                            <input type="text" name="current_basic" class="form-control" placeholder="Current Basic">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="misc_advance" class="form-control" placeholder="Misc/Advance">
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                   <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="misc_deduction" class="form-control" placeholder="Misc Deduction">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text" class="control-label col-md-4">Misc Deduction Date: </label>
                        <div class="col-md-8">
                            <!-- <input type="text" name="misc_deduction_date" class="form-control" placeholder="yyyy-mm-dd" id="miscdeductiondate" readonly=""> -->
                            <input type="date" name="misc_deduction_date" class="form-control" value="{{date('Y-m-d')}}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="bank_number" class="form-control" placeholder="Bank A/c Number">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input-text" class="control-label col-md-4">PF A/c Number: </label>
                        <div class="col-md-8">
                            <input type="text" name="pf_number" class="form-control" placeholder="PF A/c Number">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <label class="radio-inline">
                                <input type="radio" name="pf_applicable" class="radio-blue" value="Yes"> Yes</label>
                        </div>
                        <div class="col-md-4">
                            <label class="radio-inline">
                                <input type="radio" name="pf_applicable" class="radio-blue" value="No" checked> No</label>
                        </div>
                    </div>
                </div>
                </div>
