        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    ...
                    <form class="form-horizontal" action="{{ route('ledger.general-ledger-all') }}" method="get">
                        {{csrf_field()}}
                    <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-4">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="col-md-12 col-sm-12 col-lg-12 text-center">
                                            ...
                                            <h5>
                                                GENERAL LEDGER REPORT OF {{$subname->name}}  
                                            <br>
...
@endphp
                                    <td>{{$i++}}</td>
                                    <td>{{date('d-m-Y',strtotime($from_date))}} {{' OPENING'}}</td>
                                    @if($opening >= 0)
                                    @php
                                    $opnbalcr=$opening;
                                    @endphp
