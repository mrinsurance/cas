...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Product's Type</li>
        </ol>
    </section>
    <!--section ends-->
                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Master / Product's Type
                        </h3>
                        @can('product-create')
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{MASTER_URL_PRODUCT_TYPE}}/create"><i class="fa fa-plus-circle"></i> Add New Lead</a>
                        </div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                   @foreach($items as $item)
                                      <tr id="product{{$item->id}}">
                                        ...
                                        <td>{{$item->name}}</td>
                                        <td>
                                            <a href="{{MASTER_URL_PRODUCT_TYPE.'/'.$item->id.'/edit'}}" title="Edit"  class="btn btn-success">
