                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{MASTER_URL_LOAN_PURPOSE}}create"><i class="fa fa-plus-circle"></i> Add New Lead</a>
                        </div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                   @foreach($items as $item)
                                      <tr id="product{{$item->id}}">
                                        ...
                                        <td>
                                            @can('product-edit')
                                          <a href="{{MASTER_URL_LOAN_PURPOSE.''.$item->id}}/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                          @endcan
                                        </td>
                                      </tr>
                                    @endforeach
