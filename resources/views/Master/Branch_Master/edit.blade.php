            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_BRANCH.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
  {{csrf_field()}}
  {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="message">Branch Name</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="mobile" class="form-control col-md-7 col-xs-12" value="{{$item->mobile}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <textarea name="address" cols="20" rows="2" class="form-control col-md-7 col-xs-12">{{$item->address}}</textarea>
