            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_POST_BRANCH}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                            <fieldset>
                                <!-- Message body -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <textarea name="address" cols="20" rows="2" class="form-control col-md-7 col-xs-12"></textarea>
