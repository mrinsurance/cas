            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_DIST.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
  {{csrf_field()}}
  {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="state" required="required" class="form-control col-md-7 col-xs-12">
