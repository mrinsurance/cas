                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            Master / Update Ledger Table
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_POST_UPDATE}}" id="post_frm" class="form-horizontal form-label-left">
                          {{csrf_field()}}
                            <fieldset>
                                <!-- Message body -->
                                ...
                                <div class="form-group">
                                  <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button type="submit" class="btn btn-responsive btn-warning btn-sm">Update</button>
                                    </div>
                                </div>
                            </fieldset>
                        </form>
