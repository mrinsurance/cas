            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_UNIT.'/'.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
  {{csrf_field()}}
  {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="message">Unit Name</label>
                                    <div class="col-md-9">
