                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Master / Designation
                        </h3>
                        @can('product-create')
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{MASTER_URL_DESIGNATION}}create"><i class="fa fa-plus-circle"></i> Add New Record</a>
                        </div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                    @foreach($items as $item)
                                      <tr id="product{{$item->id}}">
                                        ...
                                        <td>
                                            @can('product-edit')
                                          <a href="{{MASTER_URL_DESIGNATION.''.$item->id}}/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a> 
                                          @endcan
                                        </td>
                                      </tr>
                                    @endforeach
