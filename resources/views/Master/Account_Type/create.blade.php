                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            Master / Account Types / Create
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_POST_AC_TYPE}}" id="post_frm" class="form-horizontal form-label-left">
                        {{csrf_field()}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control resize_vertical" name="account_type" placeholder="Please enter your member type here..." rows="5"></textarea>
                                          <span class="color-pwd padding" id="account_type"></span>
                                    </div>
                                </div>
                          <!-- Form group -->
                            <div class="form-group">
                            <label for="name" class="col-sm-4 control-label">Image <span class="text-red">*</span></label>
                            <div class="col-sm-8">
