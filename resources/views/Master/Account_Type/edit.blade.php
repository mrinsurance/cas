            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_AC_TYPE.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
                          {{csrf_field()}}
                          {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="account_type" required="required" class="form-control" value="{{$item->name}}">
