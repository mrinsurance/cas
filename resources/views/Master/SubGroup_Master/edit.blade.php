            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_SUB_GROUP.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
  {{csrf_field()}}
  {{method_field('PUT')}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="group" required="required" class="form-control col-md-7 col-xs-12">
                                          ...
                                          <option value="{{$val->id}}" {{$val->id == $item->group_master_model_id ? 'selected' : ''}}>{{$val->name}}</option>
                                          @endforeach
                                        </select>    
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <option value="">Select</option>
                                        @foreach($balheads as $val)
                                        <option value="{{$val->id}}" {{$val->id == $item->bal_sheet_head_model_id ? 'selected' : ''}}>{{$val->name}}</option>
                                        @endforeach
                                      </select>     
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select name="sub_group_for" class="form-control col-md-7 col-xs-12">
                                          <option value="">Select</option>
                                          @foreach($Sub_Group_For_Arr as $val)
                                          <option value="{{$val}}" {{$val == $item->sub_group_for ? 'selected' : ''}}>{{$val}}</option>
                                          @endforeach
                                        </select>        
