                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{ route('master.sale.party.create') }}"><i class="fa fa-plus-circle"></i> Add New</a>
                        </div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                   @foreach($items as $item)
                                      <tr id="product{{$item->id}}">
                                        ...
                                        <td>{{$item->address}}</td>
                                        <td>
                                            <a href="{{ route('master.sale.party.edit', $item->id) }}" title="Edit"  class="btn btn-success">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger delete-product" value="{{ route('master.sale.party.delete', $item->id) }}" title="Delete"><i class="fa fa-trash"></i> </button>
