                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            Master / Seesion / Create
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="{{MASTER_URL_POST_SESSION}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="start_date" placeholder="yyyy-mm-dd" required="required" class="date-picker form-control col-md-7 col-xs-12" id="date_start" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="end_date" placeholder="yyyy-mm-dd" required="required" class="form-control col-md-7 col-xs-12" id="date_end" readonly>
