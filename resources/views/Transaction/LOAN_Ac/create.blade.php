            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_POST_LOAN_AC}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    ...
                    <span id="loop_input"></span>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="date" name="date_of_transaction" class="form-control col-md-7 col-xs-12" value="{{date('Y-m-d')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      <select name="guarantor_one" class="form-control">
                                        ...
                                        <option value="{{$val->id}}">{{$val->account_no}} - {{$val->full_name}} - {{ $val->father_name }}</option>
                                        @endforeach
                                      </select>
...
<script>
  function guarantor1(){
   ...
   url =`{{url('transaction/loan/')}}`+"/guarantor_one?guarantor_one="+guarantor_one
