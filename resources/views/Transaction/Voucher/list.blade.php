                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="{{TRANSACTION_URL_VOUCHER}}create"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                        @endcan
                    </div>
                                ...
                                <tbody>
                                  ...
                                  <tr id="product{{$item->id}}">
                                    ...
                                    <td>
                                        @if(!$CheckLock)
                                    @can('product-edit')
                                      <a href="{{TRANSACTION_URL_VOUCHER.''.$item->id}}/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                    @endcan  
                                    @can('product-delete')  
    <button type="button" class="btn btn-danger btn-sm delete-product" value="{{TRANSACTION_URL_VOUCHER.''.$item->id}}"><i class="fa fa-trash"></i> Delete</button>
    <input type="hidden" value="{{$item->id}}" id="prd_id">
                                    @endcan
                                      <a href="{{TRANSACTION_URL_VOUCHER.''.$item->id}}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View</a>
                                        @endif
                                    </td>
                                  </tr>
                                @endforeach
