...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">DDS A/C List</li>
        </ol>
    </section>
    <!--section ends-->
                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> DDS A/C List
                        </h3>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr id="product{{$item->id}}">
                                    ...
                                    @can('product-create')
                                        @if(!$CheckLock)
                                      <a href="{{TRANSACTION_URL_DDS_AC.'create/'.$item->id.'/'.$item->token}}" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Deposit & Withdrawal"><i class="fa fa-edit"></i> D/W</a>

                                      <a href="{{TRANSACTION_URL_DDS_AC.''.$item->id}}" class="btn btn-success btn-sm"><i class="fa fa-list"></i> Transactions</a>
                                            @endif
                                    @endcan
                                    </td>
                                  </tr>
