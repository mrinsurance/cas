...
@push('extra_js')
  ...
  <script src="{{ASSETS_JS}}dds_ac.js"></script>
@endpush
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>DDS A/c of - {{$item->member_type_model->name}} A/C No. -  {{$item->account_no}} ({{$item->open_new_ac_model->full_name}})</h1>
        <ol class="breadcrumb">
            <li>
                <a href="{{HOME_LINK}}">
            ...
            <li>
                <a href="{{TRANSACTION_URL_DDS_AC}}"> A/C List </a>
            </li>
            <li class="active">Edit Entry of the A/c DDS</li>
        </ol>
    </section>
    <!--section ends-->
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_DDS_AC.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    {{method_field('PATCH')}}
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" value="{{$item->amount}}" name="amount" class="form-control col-md-7 col-xs-12 amount" onkeypress="return isNumberKey(event)" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <!-- <input type="text" value="{{$item->date_of_transaction}}" name="date_of_transaction" class="form-control col-md-7 col-xs-12" id="transaction_date" value="{{date('Y-m-d')}}" readonly="readonly"> -->
                                ...
                                <div id="cheque_mode" class="{{$item->mode_of_transaction == 'Cash' ? 'hide' : 'show'}}">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" name="cheque_date" class="form-control col-md-7 col-xs-12" id="date_of_cheque" value="{{$item->cheque_date == '' ? date('Y-m-d') : $item->cheque_date}}" readonly="readonly" disabled>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <input type="text" value="{{$item->cheque_no}}" name="cheque_number" class="form-control col-md-7 col-xs-12 cheque_number" onkeypress="return isNumberKey(event)"  disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <textarea name="transaction_particular" class="form-control col-md-7 col-xs-12" cols="30" rows="1" id="trans_particular">{{$item->particular == '' ? 'Deposite by Cash' : $item->particular}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <textarea name="remarks" class="form-control col-md-7 col-xs-12" cols="30" rows="1">{{$item->remarks}}</textarea>
                          ...
                          <table class="table table-bordered table-hover">
                              <tbody>
                                  <tr>
                                      ...
                                      <td><div id="sign" class="thumbnail">
                                        <img src="{{PREFIX1.''.$item->open_new_ac_model->signature}}" width="150" alt=""></div></td>
                                  </tr>
                                </tbody>
                              </table>
                              <table class="table table-bordered table-hover">
