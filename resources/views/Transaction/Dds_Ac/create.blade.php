...
@push('extra_js')
  ...
  <script type="text/javascript" src="{{ASSETS_JS}}dds-blur-request.js"></script>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_POST_DDS_AC}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    <input type="hidden" name="open_ac_id" id="open_ac_id">
                    <input type="hidden" name="ajax_url" value="{{url('transaction/dds/blur')}}" id="ajax_url">
                            <fieldset>
                                <!-- Name input-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      ...
                                      <input type="date" name="date_of_transaction" class="form-control" value="{{date('Y-m-d')}}">
                                ...
                                <div id="cheque_mode" class="hide">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" name="cheque_date" class="form-control col-md-7 col-xs-12" id="date_of_cheque" value="{{date('Y-m-d')}}" readonly="readonly" disabled>
