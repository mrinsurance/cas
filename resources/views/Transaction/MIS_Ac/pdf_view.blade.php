        ...
        <div class="receipt-main col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
          ...
          <div class="col-xs-10 col-sm-10 col-md-10 text-right">
            <div class="receipt-right">
              <h3 class="text-blue"><strong>{{$data['company_profile']->name}}</strong></h3>
                       <h4>{{$data['company_profile']->address}}</h4>
                       <h6>Reg.: CIN-U65990UP2019PLC117354</h6>
            </div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <h4 class="text-blue"><strong>Monthly Income Scheme Receipt
      ...
      <div class="row">
        ...
        <div class="receipt-header receipt-header-mid">
          <div class="col-xs-8 col-sm-8 col-md-8 text-left">
            ...
            <h4>MIS No.: <strong>{{@$data['item']->mis_no}}</strong></h4>
          </div>
          <div class="col-xs-4 col-sm-4 col-md-4 text-right">
            <h5>Dated: <strong>{{date('d-M-Y',strtotime(@$data['item']->start_date))}}</strong></h5>
...
<p>
  As a term deposit for - <strong>{{@$data['item']->period_of_mis}} Months</strong> bearing interest @ <strong>{{@$data['item']->int_rate}}%</strong>.
</p>
<p>
  Monthly Interest Installment Amount - <strong>&#8377; {{@$data['item']->monthly_installment}}/- </strong>
</p>
<hr>
              </div>
            </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        <tr>
                            <td>{{date('d-M-Y',strtotime(@$data['item']->start_date))}}</td>
                            <td> {{@$data['item']->period_of_mis}}</td>
