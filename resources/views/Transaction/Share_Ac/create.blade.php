...
@push('extra_js')
  ...
  <script type="text/javascript" src="{{ASSETS_JS}}share-blur-request.js"></script>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-danger" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_POST_SHARE_AC}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}

                    <input type="hidden" name="ajax_url" value="{{url('transaction/share/blur')}}" id="ajax_url">
                    <input type="hidden" id="open_ac_id" name="open_ac_id">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <!-- <input type="text" name="date_of_transaction" class="form-control" id="transaction_date" value="{{date('Y-m-d')}}" readonly="readonly"> -->
