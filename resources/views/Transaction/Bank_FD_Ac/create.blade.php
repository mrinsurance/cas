...
@push('extra_js')
  ...
  <script type="text/javascript" src="{{ASSETS_JS}}bank-fd-blur-request.js"></script>
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_POST_BANK_FD_AC}}" id="post_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
