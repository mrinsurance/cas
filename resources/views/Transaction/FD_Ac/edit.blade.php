        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <form method="post" action="{{TRANSACTION_URL_FD_AC.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                     ...
                                     <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input type="text" name="fd_no" value="{{$item->fd_no}}" class="form-control" onkeypress="return isNumberKey(event)">
                          ...
                          <div class="col-md-9">
                            ...
                            <span class="color-pwd" id="interest_rate"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="PaidInterest" class="form-control" value="{{ $item->paid_interest }}" onkeypress="return isNumAndDecimalKey(event)" >
                            ...
                            <input type="text" name="lf_no" value="{{$item->lf_no}}" class="form-control">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-right btn-group-md">
                                        ...
                                        <a class="btn btn-success btn_sizes" target="_blank" href="{{TRANSACTION_URL_FD_AC.'print-pdf/'.$item->id.'/'.$item->token}}"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                                        @endif
                                    </div>
                                </div>
                            </fieldset>
                  ...
                  <div class="panel-body" style="height: 995px;">
                      <div class="table-scrollable">
                          <table class="table table-bordered table-hover">
                              <tbody>
                                  <tr>
                                      <td><div class="thumbnail "><img src="{{PREFIX1.''.$customer->file}}" alt="" width="150" class="img-responsive"></div></td>
                                      <td><div class="thumbnail"><img src="{{PREFIX1.''.$customer->signature}}" alt="" width="150" class="img-responsive"></div></td>
                                  </tr>
                                </tbody>
                              </table>
                              <table class="table table-bordered table-hover">
                              <tbody>
                                  <tr>
                                      <th>Branch</th>
                                      <td>{{$customer->branch_model->name ?? ''}}</td>
                                  </tr>
                                  <tr>
                                    <th>Member Name</th>
                                  ...
                                  <tr>
                                    <th>Address</th>
                                      <td>{{$customer->village}} {{$customer->post_office}} {{$customer->district_model->name ?? ''}} ({{$customer->state_model->name ?? ''}})</td>
                                  </tr>
                                   <tr>
                                    <th>Ledger Folio</th>
                                      <td>{{$item->lf_no}}</td>
