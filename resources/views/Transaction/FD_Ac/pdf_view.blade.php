...
<p><strong>
  &#8377; {{number_format(@$data['item']->amount,2)}} - ({{ getIndianCurrency(@$data['item']->amount) }})
</strong>
</p>
<p>
  Maturity Value <strong>&#8377; {{number_format(@$data['item']->maturity_amount,2)}} ({{ getIndianCurrency(@$data['item']->maturity_amount) }})
</strong>
</p>
<p>
