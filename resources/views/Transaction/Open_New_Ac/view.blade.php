                                            ...
                                            <div class="panel-body">
                                                <div class="col-md-3">
                                                    <div class="text-center">
                                                        <div class="fileinput">
                                                            <div class="thumbnail">
                                                                <img src="{{PREFIX1.''.$item->file}}" width="200" class="img-responsive"  alt="SMBNL">
                                                            </div>
                                                        </div>
                                                        <div class="fileinput">
                                                            <div class="thumbnail">
                                                                
                                                                <img src="{{PREFIX1.''.$item->signature}}" width="200" class="img-responsive"  alt="SMBNL">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{date('d-M-Y',strtotime($item->ac_opening_date))}}</td>
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th>Nominee DOB</th>
                                                                <td>{{date('d-M-Y',strtotime($item->nominee_dob))}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th>Agent Code</th>
