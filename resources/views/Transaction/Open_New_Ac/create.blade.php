            ...
            <div class="col-lg-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_POST_OPEN_NEW_AC}}" id="post_frm" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                    {{csrf_field()}}
                            <div class="form-body">
                                <!-- Form Group                               -->
                ...
                <span class="color-pwd" id="occupation"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="vehicle[]" class="square-blue" value="{{$val}}">&nbsp; {{$val}}</label>
                                        </div>
                                        @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <input type="date" name="validity_of_passport" class="form-control" value="{{date('Y-m-d')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <input type="date" name="nominee_dob" class="form-control" value="{{date('Y-m-d')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="checkbox-inline">
                                            <label>
                                                <input type="checkbox" name="ac_permissions[]" class="square-blue" value="{{$val}}" @if($i == 1) checked @endif>&nbsp; {{$val}}</label>
                                        </div>
                                        @php $i++; @endphp
                                        @endforeach
