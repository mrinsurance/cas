                    ...
                    {{method_field('PUT')}}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                       <input type="text" {{ Auth::user()->hasAnyRole('SuperAdmin') ? '' : 'disabled' }} value="{{$item->account_no}}" placeholder="Account number" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <input type="date" name="ac_opening_date" class="form-control" value="{{$item->ac_opening_date}}">
                ...
                <span class="color-pwd" id="permanent_pin_code"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="date_of_birth" class="form-control" value="{{$item->dob}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      <!-- <input type="text" value="{{$item->passport_validity ? $item->passport_validity : date('Y-m-d')}}" name="validity_of_passport"  placeholder="yyyy-mm-dd" id="valid_passport_date" class="form-control" readonly> -->
                                      <input type="date" name="validity_of_passport" class="form-control" value="{{$item->passport_validity ? $item->passport_validity : date('Y-m-d')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <input type="date" name="nominee_dob" class="form-control" value="{{$item->nominee_dob}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" value="{{$item->ward}}" name="ward" placeholder="Ward Number" class="form-control">
                ...
                <span class="color-pwd" id="page"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="checkbox-inline">
                                            <label>
                                                <input type="checkbox" name="ac_permissions[]" class="square-blue" value="{{$val}}" {{in_array($val,$match_permissions) ? 'checked' : ''}}>&nbsp; {{$val}}</label>
                                        </div>
                                        @endforeach
                                  ...
                                  <label for="inputUsername" class="col-md-3 control-label">
                                    ...
                                    <div class="col-md-6 text-center">
                                            <div class="col-md-6 thumbnail">
                                                <img src="{{PREFIX1.''.$item->file}}" class="img-responsive" height="100" id="imgphoto">
                                            ...
                                            <div class="col-md-6 thumbnail">
                                                <img src="{{PREFIX1.''.$item->signature}}" class="img-responsive" height="100" id="imgsignature">
