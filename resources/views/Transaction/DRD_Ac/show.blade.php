                          ...
                          <div class="col-md-8">
                            ...
                            <span class="color-pwd" id="interest_rate"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                     <input type="text" name="drd_date" class="form-control" id="drd_start_date" value="{{$item->transaction_date}}" readonly="readonly">
...
<!-- Maturity Date -->
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <input type="text" name="maturity_date" class="form-control" id="maturity_date_cal" value="{{$item->maturity_date}}" readonly="readonly">
...
<!-- Nominee Relation -->
            ...
            <div class="col-md-6">
                <div class="panel panel-primary" id="hidepanel2">
                  ...
                  <div class="panel-body" style="height: 618px;">
