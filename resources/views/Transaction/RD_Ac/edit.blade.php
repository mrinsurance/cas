...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>RD A/c of - {{$user_detail->full_name}} A/C No. -  {{$item->account_no}}</h1>
        <ol class="breadcrumb">
            <li>
                <a href="{{HOME_LINK}}">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="{{TRANSACTION_URL_RD_AC.''.$item->id}}" id="edit_frm" class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    {{method_field('PUT')}}
                    <input type="hidden" name="ajax_url" value="{{url('transaction/recurring-deposite/blur')}}" id="ajax_url">
                            <fieldset>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input type="text" value="{{$item->rd_no}}" class="form-control" disabled>
                                      </div>
                                    </div>
                                <!-- Email input-->
                                <div class="form-group">
                          ...
                          <div class="col-md-9">
                            ...
                            <span class="color-pwd" id="interest_rate"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                     <input type="date" name="rd_date" class="form-control" id="rd_start_date" value="{{$item->transaction_date}}">
...
<!-- Period of FD -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="text" value="{{$item->period_rd}}" name="period_of_rd" class="form-control" id="month_of_period" onkeypress="return isNumberKey(event)">
...
<!-- Maturity Date -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="date" name="maturity_date" class="form-control" id="maturity_date_cal" value="{{$item->maturity_date}}">
...
<!-- Matured on Date -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="date" name="matured_on_date" class="form-control" id="matured_on_date_cal" value="{{$item->matured_on_date}}">
...
<!-- LF No -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="text" name="lf_no" value="{{$item->lf_no}}" class="form-control">
                          </div>
                        </div>                        
                                <!-- Form actions -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 text-right btn-group-md">
                                        ...
                                        <a class="btn btn-success btn_sizes" target="_blank" href="{{TRANSACTION_URL_RD_AC.'print-pdf/'.$item->id.'/'.$item->token}}"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                                        @endif
                                    </div>
                                </div>
                            </fieldset>
