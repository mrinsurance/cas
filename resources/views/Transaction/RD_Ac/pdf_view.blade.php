  ...
  <div class="row">
        ...
        <div class="receipt-main col-xs-12 col-sm-12 col-md-8 col-md-offset-2">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <h4 class="text-blue"><strong>Recurring Deposit Receipt 
      ...
      <div class="row">
        ...
        <div class="receipt-header receipt-header-mid">
          <div class="col-xs-8 col-sm-8 col-md-8 text-left">
            ...
            <h4>RD No.: <strong>{{@$data['item']->rd_no}}</strong></h4>
          </div>
...
<p><strong>
  &#8377; {{number_format(@$data['item']->amount,2)}} - ({{\App\Http\Controllers\Transaction\fdController::convert_number_to_words(@$data['item']->amount)}}) Monthly Installment
</strong>
</p>
<p>
...
<p>
  As a term deposit for - <strong>{{@$data['item']->period_rd}} Months</strong> bearing interest @ <strong>{{@$data['item']->int_rate}}%</strong> per annum.
</p>
<hr>
              </div>
            </div>
      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <table class="table table-bordered table-responsive">
                    ...
                    <tbody>
                        <tr>
                            <td>{{date('d-M-Y',strtotime(@$data['item']->transaction_date))}}</td>
                            <td> {{@$data['item']->period_rd}}</td>
