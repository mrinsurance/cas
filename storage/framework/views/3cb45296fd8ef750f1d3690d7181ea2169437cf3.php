                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box primary">
                        ...
                        <div class="portlet-body">
                            <form class="form-horizontal" action="<?php echo e(route('daily.report.bank.fd.status.report')); ?>" method="get">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="bank" class="form-control">
                                                <option value="">All</option>
                                                <?php $__currentLoopData = BankList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select name="report" class="form-control">
                                                <?php $__currentLoopData = ReportName2(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="table-scrollable">
                                ...
                                <div class="prnt" id="record">
                                    ...
                                    <table class="table table-bordered table-hover" id="mytable_css">
                                                ...
                                                <div class="col-md-12 text-center">
                                                    ...
                                                    <h4>
                                                        <?php $__currentLoopData = BankList(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <?php endif; ?>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        Bank FD <?php echo e(request()->get('report')); ?> Report from <?php echo e(\Carbon\Carbon::parse(request()->get('fromDate'))->format('d-M-Y')); ?>
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th class="<?php echo e(isset(request()->bank) ? 'hide' : ''); ?>">Bank Name</th></th>
                                            <th>A/C No.</th>
                                            <th>FD No.</th>
                                            <th>FD Dated</th>
                                        ...
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <?php if(request()->wp == FALSE): ?>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($item->maturity_amount - $item->amount,2)); ?></td>
                                                <?php endif; ?>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/Daily_Report/bank-fd-status-report.blade.php ENDPATH**/ ?>