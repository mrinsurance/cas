...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo e(route('master.sale.party.index')); ?>">
                    List
                </a>
            </li>
            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(route('master.sale.party.update', $item->id)); ?>" id="edit_frm" class="form-horizontal form-label-left">
  ...
  <?php echo e(method_field('PUT')); ?>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="address" rows="5" class="form-control"><?php echo e($item->address); ?></textarea>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/Master/Sale-Party/edit.blade.php ENDPATH**/ ?>