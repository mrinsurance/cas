        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="<?php echo e(DIVIDEND_CALCULATION_URL); ?>" method="get">
                    <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-3">
                                <input name="maximum_share" type="text" class="form-control" onkeypress="return isNumAndDecimalKey(event)" value="<?php echo e(old('maximum_share',@$_REQUEST['maximum_share'])); ?>" required>
                            </div>
                        </div>
                    </div>
                    </div>
                  ...
                  <div>  <?php echo e(@($_REQUEST['view'])?$ac_holders->appends(['_token' => $_REQUEST['_token'],'share_as_on' => $_REQUEST['share_as_on'],'maximum_share' => $_REQUEST['maximum_share'],'session_year' => $_REQUEST['session_year'],'paid_on' => $_REQUEST['paid_on'],'dividend_at' => $_REQUEST['dividend_at'],'minimum_share' => $_REQUEST['minimum_share'],'view' => $_REQUEST['view']])->render():''); ?></div>
                       <?php endif; ?>
                  ...
                  <?php if(session()->has('success')): ?>
                    <div class="alert alert-info">
                              ...
                              <?php endif; ?>
                    <form class="form-horizontal" action="<?php echo e(DIVIDEND_CALCULATION_URL); ?>"  method="post">
                    <div class="row">
                        <?php echo e(csrf_field()); ?>
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <h4>
                                                Dividend Paid Upto <strong><?php echo e(date('d-M-Y',strtotime($share_as_on))); ?></strong> Paid on <strong> <?php echo e(date('d-M-Y',strtotime($paid_on))); ?></strong>
                                            </h4>    
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <tbody>
                               ...
                               <?php if($opening_balance <> 0 || $deposit_trans <> 0 || $withdraw_trans <> 0): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="align_right">
                                        <i class="fa fa-inr"></i>   <?php echo e(number_format($tdiv,2)); ?>

                                        <input type="hidden" name="s_no_id[]" value="<?php echo e($sr+(@($_REQUEST['page'])?$_REQUEST['page'].'00':00)); ?>">
                                
                                        <input type="hidden" name="dividend_balance[]" value="<?php echo e($tdiv); ?>">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbarin.himachalsociety.com/resources/views/Calculation/dividend-calculation.blade.php ENDPATH**/ ?>