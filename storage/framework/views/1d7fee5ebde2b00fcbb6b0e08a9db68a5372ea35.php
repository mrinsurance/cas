...
<?php $__env->startPush('extra_js'); ?>
  ...
  <script type="text/javascript" src="<?php echo e(ASSETS_JS); ?>dds-blur-request.js"></script>
  <script src="<?php echo e(ASSETS_JS); ?>changestate.js"></script>
  <script src="<?php echo e(ASSETS_JS); ?>dds_ac.js"></script>
<?php $__env->stopPush(); ?>
...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo e(TRANSACTION_URL_DDS_AC); ?>"> A/C List </a>
            </li>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRANSACTION_URL_POST_DDS_AC); ?>" id="post_frm" class="form-horizontal form-label-left">
                    <?php echo e(csrf_field()); ?>

                    <input type="hidden" name="open_ac_id" id="open_ac_id">
                    <input type="hidden" name="ajax_url" value="<?php echo e(url('transaction/dds/blur')); ?>" id="ajax_url">
                            <fieldset>
                                <!-- Name input-->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" name="account_no" class="form-control ac_no" id="ac_no">
                                      </div>
                                </div>
                                <!-- Email input-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 text-right btn-group-md">
                                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-create')): ?>
                                          <?php if(!$CheckLock): ?>
                                            ...
                                            <a href="#" class="btn btn-warning btn_sizes" id="view_ac" disabled target="_new"><i class="fa fa-list"></i> Transactions</a>
                                            <?php endif; ?>
                                      <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/Transaction/Dds_Ac/create.blade.php ENDPATH**/ ?>