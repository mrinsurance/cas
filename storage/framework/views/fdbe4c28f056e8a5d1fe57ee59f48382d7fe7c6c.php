                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php if($item->apr_status == FALSE): ?> <?php echo e(TRADING_URL_SALE.'/'.$item->id); ?> <?php else: ?> # <?php endif; ?>" id="post_frm" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                      ...
                                      <select name="sale_to" class="form-control" required="">
                                        <option value="">Select</option>
                                          <?php $__currentLoopData = getSaleParty(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <option value="<?php echo e($list['id']); ?>" <?php echo e($item->client == $list['id'] ? 'selected' : ''); ?>><?php echo e($list['name']); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <select name="sale_by" class="form-control" required="">
                                        ...
                                        <option value="<?php echo e($list); ?>" <?php echo e($item->sale_by == $list ? 'selected' : ''); ?>><?php echo e($list); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
...
<?php endif; ?>                        
                                    ...
                                    <div class="col-md-2">
                                      <span class="text-dark">Product Name</span>
                                        <select name="product_name" class="form-control" id="product_name" required="">
                                          <option value="">--- Select ---</option>
                                            <?php $__currentLoopData = getProductNameByTypeId($item->product_type_master_tbl_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e(number_format($saleDetail->sum('amount_without_tax'),2)); ?></strong></td>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e(number_format($saleDetail->sum('igst'),2)); ?></strong></td>
                  ...
                  <?php if(count($saleDetail) > 0): ?>                      
                  <div class="row mb-10">
                      <div class="col-md-12 text-center">
                        <form method="post" action="<?php echo e(TRADING_URL_SALE); ?>/aproved" class="form-horizontal form-label-left" >
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="product" value="<?php echo e($item->product_type_master_tbl->name); ?>">
                        <input type="hidden" name="client" value="<?php echo e($item->sale_by); ?>">
                        ...
                        <input type="hidden" name="amount" value="<?php echo e($saleDetail->sum('amount')); ?>">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Sale/edit.blade.php ENDPATH**/ ?>