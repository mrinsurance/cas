        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="<?php echo e(LEDGER_REPORT_URL_PERSONAL_LEDGER); ?>" method="get">
                    <div class="row">
                    <div class="col-md-12">
                           ...
                           <table class="table table-bordered table-hover" id="mytable_css">
                            <thead>
                                <tr>
                                    <td colspan="11">
                                        ...
                                        <div class="row">
                                            ...
                                            <strong>Member A/C no.: </strong> <em><?php echo e(@$_holder->account_no); ?></em>
                                            <br>
                                            <strong>Name: </strong> <em><?php echo e(@$_holder->full_name); ?></em>
                                            <br>
                                            <strong>Father Name: </strong> <em><?php echo e(@$_holder->father_name); ?></em>
                                            <br>
                                            <strong>From: </strong> <em>(<?php echo e(date('d-M-Y',strtotime($from_date))); ?>)</em> <strong>To: </strong> <em>(<?php echo e(date('d-M-Y',strtotime($to_date))); ?>)</em>
                                ...
                                <tr>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($_opening_share_bal)); ?></th>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($_opening_loan_bal)); ?></th>
                                    <th></th>
                                    <th></th>
                                    <th class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($_opening_saving_bal)); ?></th>
                                </tr>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    ?>
                                <?php $__currentLoopData = $_ledger; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                       <?php echo e($list->dt); ?>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Ledger//personal_ledger.blade.php ENDPATH**/ ?>