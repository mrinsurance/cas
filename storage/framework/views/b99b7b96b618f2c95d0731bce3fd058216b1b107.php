        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    ...
                    <form class="form-horizontal" action="<?php echo e(LEDGER_REPORT_URL_HEAD_LEDGER); ?>" method="get">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="col-md-8">
                                <input type="checkbox" name="wtopen" value="1" <?php echo e(request()->get('wtopen') == true ? 'checked' : ''); ?>>
                            </div>
                        </div>
                    </div>
                    </div>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <h5>
                                                LEDGER REPORT OF <?php echo e($subname->name); ?> 
                                            <br>
...
?>
<?php if(request()->get('wtopen') == false): ?>
    <?php
      $totalbal = $opening;
?>
<tr>
    <td><?php echo e($i++); ?></td>
    <td><?php echo e(date('d-m-Y',strtotime($from_date))); ?></td>
    <td><?php echo e('OPENING'); ?></td>
    <?php if($opening >= 0): ?>
        <?php
            $opnbalcr=$opening;
        ?>
...
?>   -->                              
                                <tr>
                                    ...
                                    <td><?php echo e($mainHead->particular.' - '.$mainHead->account_no); ?></td>
                                    <?php if($mainHead->type_of_transaction=='Cr'): ?>
                                    
                                       <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($mainHead->amount,2)); ?></td>
                                       <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format(0,2)); ?></td>
                                    <?php
                                    ...
                                    <?php if($mainHead->type_of_transaction=='Dr'): ?>
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format(0,2)); ?></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($mainHead->amount,2)); ?></td>
                                    <?php
                                    $totalbal=$totalbal-$mainHead->amount;
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Ledger//head_ledger.blade.php ENDPATH**/ ?>