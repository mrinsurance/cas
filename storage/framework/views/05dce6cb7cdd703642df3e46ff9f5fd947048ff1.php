                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e(number_format($purchaseDetail->sum('sgst'),2)); ?></strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e(number_format($purchaseDetail->sum('cgst'),2)); ?></strong></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e(number_format($purchaseDetail->sum('amount'),2)); ?></strong></td>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Purchase/view.blade.php ENDPATH**/ ?>