                                        ...
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php else: ?>
                                                <?php if(count($items) == $trec): ?>
                                                    ...
                                                    <tr>
                                                        <td colspan="5"><strong>Grand Total</strong></td>
                                                        <td class="align_right"> <strong><?php echo e(number_format($totalFd,2,'.','')); ?></strong></td>
                                                        <?php if(request()->wp == FALSE): ?>
                                                            <td class="align_right"> <strong><?php echo e(number_format($totalPayble,2,'.','')); ?></strong></td>
                                                        <?php endif; ?>
                                                        <td></td>
                                                    </tr>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/BalancePageTotal/rd_balance.blade.php ENDPATH**/ ?>