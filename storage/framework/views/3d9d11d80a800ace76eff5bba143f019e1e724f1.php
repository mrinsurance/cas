        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo e(TRADING_URL_SALE_PURCHASE_REPORT); ?>" method="get">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="producttype" class="form-control">
                                ...
                                <?php $__currentLoopData = $productstype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row">
                      ...
                      Sale & Purchase Report from
                                <?php echo e(date('d-M-Y',strtotime($from_date))); ?>
...
?>
                                <tr>
                                    ...
                                    <td class="text-right"> <?php echo e(number_format( @$lastPurchaseDate->rate,2,'.','')); ?></td>
                                    <td class="text-right"><?php echo e(number_format($openQty,3,'.','')); ?>

                                    </td>
                                    <td class="text-right"> <?php echo e(number_format($openingAmt,2,'.','')); ?></td>
                                    <td class="text-right"><?php echo e(number_format($PurchaseQuantity,3,'.','')); ?></td>
                                    <td class="text-right"> <?php echo e(number_format($purchaseAmt,2,'.','')); ?> </td>
                                    <td class="text-right"><?php echo e(number_format(($openQty + $PurchaseQuantity),3,'.','')); ?></td>
                                    <td class="text-right"><?php echo e(number_format($SaleQuantity,3,'.','')); ?></td>
                                    <td class="text-right"> <?php echo e(number_format($saleAmt,2,'.','')); ?></td>
                                ...
                                <tr>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th class="text-right"> <?php echo e(number_format($openTotalAmt,2,'.','')); ?></th>
                                    <th></th>
                                    <th class="text-right"> <?php echo e(number_format($purchaseTotalAmt,2,'.','')); ?></th>
                                    <th></th>
                                    <th></th>
                                    <th class="text-right"> <?php echo e(number_format($saleTotalAmt,2,'.','')); ?></th>
                                    <th></th>
                                    <th></th>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Sale-Purchase//index.blade.php ENDPATH**/ ?>