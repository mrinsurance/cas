<?php $__env->startSection('title', 'Agent Account Assignment'); ?>
...
<aside class="right-side strech">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo e(HOME_LINK); ?>"><i class="livicon" data-name="home" data-size="14" data-loop="true"></i> Dashboard</a></li>
...
<script>
    $(document).ready(function () {
        ...
        function fetchAccounts(agentId = null, query = '') {
            $.ajax({
                url: "<?php echo e(route('fetch.accounts')); ?>",
                method: "GET",
    ...
    function fetchAssignedAccounts(agentId) {
        $.ajax({
            url: "<?php echo e(route('fetch.assigned.accounts')); ?>",
            method: "GET",
    ...
    fetchAccounts();
        ...
        $('#add-button').on('click', function () {
            ...
            $.ajax({
                url: "<?php echo e(route('save.assignments')); ?>",
                method: "POST",
                data: {
                    agent_id: agentId,
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\himachal-banking\resources\views/Transaction/Open_New_Ac/agent-permission.blade.php ENDPATH**/ ?>