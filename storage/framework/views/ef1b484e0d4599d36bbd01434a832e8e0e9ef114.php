        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo e(route('setting.rd-second')); ?>" method="get">
...
$maturity_amount = round($matured_amount);
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"><?php echo e($item->amount ?? 0); ?></td>
                                    <td class="align_right"><?php echo e($item->period_rd ?? 0); ?></td>
                                    <td class="align_right"><?php echo e($item->int_rate ?? 0); ?></td>
                                    <td class="align_right"><?php echo e($item->maturity_amount ?? 0); ?></td>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbara.himachalsociety.com/resources/views/Balance/rd_balance_second.blade.php ENDPATH**/ ?>