            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRANSACTION_URL_POST_RD_AC); ?>" id="post_frm" class="form-horizontal form-label-left">
                    ...
                    <input type="hidden" name="open_ac_id" id="open_ac_id">
                            <fieldset>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input type="text" value="<?php echo e(@$auto_id->rd_no + 1); ?>" name="rd_no" class="form-control">
                          ...
                          <div class="col-md-9">
                            ...
                            <span class="color-pwd" id="interest_rate"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                     <input type="date" name="rd_date" class="form-control" id="rd_start_date" value="<?php echo e(date('Y-m-d')); ?>">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Transaction/RD_Ac/create.blade.php ENDPATH**/ ?>