                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="<?php echo e(TRANSACTION_URL_VOUCHER_SINGLE); ?>create"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                        <?php endif; ?>
                    </div>
                                ...
                                <tbody>
                                  ...
                                  <tr id="product<?php echo e($item->id); ?>">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-edit')): ?>
                                      <a href="<?php echo e(TRANSACTION_URL_VOUCHER_SINGLE.''.$item->id); ?>/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                    <?php endif; ?>  
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-delete')): ?>  
    <button type="button" class="btn btn-danger btn-sm delete-product" value="<?php echo e(TRANSACTION_URL_VOUCHER_SINGLE.''.$item->id); ?>"><i class="fa fa-trash"></i> Delete</button>
    <input type="hidden" value="<?php echo e($item->id); ?>" id="prd_id">
                                    <?php endif; ?>
                                      <a href="<?php echo e(TRANSACTION_URL_VOUCHER_SINGLE.''.$item->id); ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View</a>
                                        <?php endif; ?>
                                    </td>
                                  </tr>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbara.himachalsociety.com/resources/views/Transaction/Voucher-Single/list.blade.php ENDPATH**/ ?>