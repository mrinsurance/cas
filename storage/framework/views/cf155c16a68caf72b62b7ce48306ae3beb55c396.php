...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>DDS A/c List - <?php echo e($profile->member_type_model->name); ?> A/C No. -  <?php echo e($profile->account_no); ?> (<?php echo e($profile->full_name); ?>)</h1>
        <ol class="breadcrumb">
            <li>
                                    ...
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr id="product<?php echo e($item->id); ?>">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-edit')): ?>
                                            <?php if(!$CheckLock): ?>
                                          <a href="<?php echo e(TRANSACTION_URL_DDS_AC.''.$item->id); ?>/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                                <?php endif; ?>
                                        <?php endif; ?>  
                                        </td>
                                        <td>
                                          <?php if($item->shadow == 0): ?>
                                            Shadow
                                            <?php else: ?>
                                            Clear
                                          <?php endif; ?>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/Transaction/Dds_Ac/transaction-list.blade.php ENDPATH**/ ?>