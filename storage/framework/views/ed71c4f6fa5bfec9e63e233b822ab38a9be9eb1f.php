        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="<?php echo e(route('audit.report.loan.advance.detail')); ?>" method="get">
                           ...
                           <table class="table table-bordered table-hover" id="mytable_css">
                            ...
                            <?php $__currentLoopData = $_loanReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                             
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($_loan->amount)); ?></td>
                                    <td class="align_right"><?php echo e($_loan->months); ?></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($_loan->interest)); ?></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($_loan->pannelty_int)); ?></td>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e(number_format($_loanTotal)); ?></strong></td>
                                    <td colspan="3" >&nbsp;</td>
                                </tr>  
                            </tbody>
                        </table>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Audit//loan-advancement-detail.blade.php ENDPATH**/ ?>