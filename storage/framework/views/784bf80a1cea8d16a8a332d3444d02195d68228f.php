                    ...
                    <div class="portlet box primary">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <a href="<?php echo e(url('balance-report/saving-paginate')); ?>" class="btn btn-success btn_sizes pull-right">Paginate View</a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" action="<?php echo e(BALANCE_REPORT_URL_SAVING); ?>" method="get">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbarin.himachalsociety.com/resources/views/Balance/saving_balance.blade.php ENDPATH**/ ?>