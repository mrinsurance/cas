<section class="content">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 margin_10 animated fadeInLeftBig">
                <a href="<?php echo e(TRADING_URL_PURCHASE); ?>">
                <!-- Trans label pie charts strats here-->
                <div class="goldbg no-radius">
                    <div class="panel-body squarebox square_boxs">
                        <div class="col-xs-12 pull-left nopadmar">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 margin_10 animated fadeInLeftBig">
                <a href="<?php echo e(TRADING_URL_SALE); ?>">
                <!-- Trans label pie charts strats here-->
                <div class="goldbg no-radius">
                    <div class="panel-body squarebox square_boxs">
                        <div class="col-xs-12 pull-left nopadmar">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 margin_10 animated fadeInUpBig">
                <a href="<?php echo e(TRADING_URL_SALE_PURCHASE_REPORT); ?>">
                <!-- Trans label pie charts strats here-->
                        ...
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    <div class="number">Sale Purchase Report</div>
                                </div>
            ...
            <div class="col-lg-3 col-sm-6 col-md-6 margin_10 animated fadeInDownBig">
                <a href="<?php echo e(url('trading/item-ledger')); ?>">
                <!-- Trans label pie charts strats here-->
                <div class="palebluecolorbg no-radius">
                    <div class="panel-body squarebox square_boxs">
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    <div class="number">Item Ledger</div>
                                </div>
                ...
                <div class="redbg no-radius">
                    <div class="panel-body squarebox square_boxs">
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    <div class="number">Stock Report</div>
                                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 margin_10 animated fadeInLeftBig">
                <a href="<?php echo e(route('trading.sale.collection.report')); ?>">
                <!-- Trans label pie charts strats here-->
                <div class="lightbluebg no-radius">
                    <div class="panel-body squarebox square_boxs">
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 text-right">
                                    <div class="number">Collection Report</div>
                                </div>
        ...
        <!--/row-->
    </section><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/component/saleman-dashboard.blade.php ENDPATH**/ ?>