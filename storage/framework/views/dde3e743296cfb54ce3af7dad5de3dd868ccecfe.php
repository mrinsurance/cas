...
<?php $__env->startPush('extra_js'); ?>
  ...
  <script type="text/javascript" src="<?php echo e(ASSETS_JS); ?>deleterole.js"></script>
<?php $__env->stopPush(); ?>
                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            ...
                            <a class="btn btn-default btn-sm" href="<?php echo e(ROLES); ?>/create"><i class="fa fa-plus-circle"></i> Create New Role</a>
                            <?php endif; ?>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  ...
                                  <tr id="product<?php echo e($item->id); ?>">
                                    ...
                                    <td>
                                      <a href="<?php echo e(ROLES.'/'.$item->id); ?>" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> View</a>
                                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-edit')): ?>
                                      <a href="<?php echo e(ROLES.'/'.$item->id); ?>/edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                      <?php endif; ?>
                                      <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('role-delete')): ?>
                                      <button type="button" class="btn btn-danger btn-sm delete-product" value="<?php echo e('/'.$item->id); ?>"><i class="fa fa-trash"></i> Delete</button>
                                      <?php endif; ?>
                                    </td>
                                  </tr>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/roles/index.blade.php ENDPATH**/ ?>