                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRADING_URL_PURCHASE); ?>" id="post_frm" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <input type="text" name="invoice_no" class="form-control" placeholder="Invoice no" value="<?php echo e(@$invoice); ?>" readonly="">
                                     <span class="color-pwd" id="invoice_no"></span>
                                    </div>
                                    <div class="col-md-3">
                                      <span class="text-dark">Bill no</span>
                                      <input type="text" name="bill_no" class="form-control" placeholder="Bill no" required="" value="<?php echo e(@$bill); ?>">
                                     <span class="color-pwd" id="bill_no"></span>
                                    </div>
                                    <div class="col-md-3">
                                      <span class="text-dark">Date</span>
                                      <input type="date" name="date" placeholder="YYYY-MM-DD" class="form-control" value="<?php echo e($date ? $date : date('Y-m-d')); ?>" data-error="Date is required">
                                     <span class="color-pwd" id="date"></span>
                                    </div>
                                    <div class="col-md-3">
                                      <span class="text-dark">Bill Date</span>
                                      <input type="date" name="bill_date" placeholder="YYYY-MM-DD" class="form-control" value="<?php echo e($billDate ? $billDate : date('Y-m-d')); ?>" data-error="Bill date is required">
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <select name="purchase_party" class="form-control" required="">
                                        ...
                                        <option value="<?php echo e($list->id); ?>" <?php echo e($purchaseParty == $list->id ? 'selected' : ''); ?>><?php echo e($list->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <select name="product_party" class="form-control" required="">
                                        ...
                                        <option value="<?php echo e($list->id); ?>" <?php echo e($productParty == $list->id ? 'selected' : ''); ?>><?php echo e($list->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                    ...
                                    <div class="col-md-3">
                                      <span class="text-dark">Branch</span>
                                        ...
                                        <?php $__currentLoopData = $branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <option value="<?php echo e($val->id); ?>" <?php echo e($branchName == $val->id ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                    </div>
                            </div>
                             ...
                             <!-- Form Group  For head entry -->
                                <div class="form-group">
                                    <div class="col-md-2">
                                      <span class="text-dark">Product Name</span>
                                        <select name="product_name" class="form-control" id="product_name">
                                          <option value="">Select</option>
                                          <?php $__currentLoopData = getProductNameByTypeId($productParty); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <input type="text" name="quantity" class="form-control text-right" placeholder="Quantity" id="quantity_id" onkeyup="CalculateRate();">
                                     <span class="color-pwd sub_error" id="quantity"></span>
                                    </div>
                                    <div class="col-md-2">
                                      <span class="text-dark">Amount</span>
                                      <input type="text" name="total_amount" class="form-control text-right" placeholder="Total Amount" id="total_amount_id" onkeyup="CalculateRate();">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Purchase/create.blade.php ENDPATH**/ ?>