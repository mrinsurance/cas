...
<aside class="right-side strech">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>
          <a href="<?php echo e(TRADING_URL_PURCHASE); ?>"> List </a>
        </li>
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php if($item->apr_status == FALSE): ?>
  <?php echo e(TRADING_URL_PURCHASE.'/'.$item->id); ?> <?php else: ?> # <?php endif; ?>" id="post_frm" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                          <input type="hidden" value="<?php echo e(TRADING_URL_PURCHASE); ?>/create" id="getUrl">
                        ...
                        <div class="form-body">
                                ...
                                <div class="form-group">
                                    <div class="col-md-3">
                                        ...
                                        <select name="billType" class="form-control" onchange="CalculateRate();">
                                            <?php $__currentLoopData = BillTypeArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($list['id']); ?>" <?php echo e($list['id'] == $item->bill_type ?? 'selected'); ?>><?php echo e($list['label']); ?></option>
                                    ...
                                    <div class="col-md-3">
                                      <span class="text-dark">Bill no</span>
                                      <input type="text" name="bill_no" class="form-control" placeholder="Bill no" required="" value="<?php echo e($item->bill_no); ?>">
                                     <span class="color-pwd" id="bill_no"></span>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                      <span class="text-dark">Purchase By</span>
                                      <select name="purchase_by" class="form-control" required="">
                                        <option value="">Select</option>
                                        <option value="CASH" <?php echo e($item->purchase_by == 'CASH' ? 'selected' : ''); ?>>CASH</option>
                                        <option value="SUNDRY CREDITOR" <?php echo e($item->purchase_by == 'SUNDRY CREDITOR' ? 'selected' : ''); ?>>SUNDRY CREDITOR</option>
                                      </select>
                                     <span class="color-pwd" id="purchase_by"></span>
                                    </div>
                                    <div class="col-md-3">
                                      <span class="text-dark">Purchase Party</span>
                                      <select name="purchase_party" class="form-control" required="">
                                        <option value="">Select</option>
                                        <?php $__currentLoopData = $purchasePartyList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($list->id); ?>" <?php echo e($item->purchase_party_tbl_id == $list->id ? 'selected' : ''); ?>><?php echo e(@$list->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      </select>
                                     <span class="color-pwd" id="purchase_party"></span>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                      <?php if($item->apr_status == FALSE): ?>
                                      <button type="submit" id="button1" class="btn btn-success btn_sizes" name="button1" value="1">  Update</button>
                                      <?php else: ?>
                                      <button type="button" class="btn btn-success btn_sizes" disabled name="button1" >  Update</button>
                                      <?php endif; ?>
                                    </div>
                            </div>
                          </div>
...
<?php endif; ?>                        
                             <!-- Form Group  For head entry -->
                                <div class="form-group">
                                    <div class="col-md-2">
                                      <span class="text-dark">Product Name</span>
                                        <select name="product_name" class="form-control" id="product_name" required="">
                                          <option value="">--- Select ---</option>
                                            <?php $__currentLoopData = getProductNameByTypeId($item->purchase_party_tbl_id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <input type="text" name="quantity" class="form-control text-right" placeholder="Quantity" id="quantity_id" onkeyup="CalculateRate();" required>
                                     <span class="color-pwd sub_error" id="quantity"></span>
                                    </div>
                                    <div class="col-md-2">
                                      <span class="text-dark">Amount</span>
                                      <input type="text" name="total_amount" class="form-control text-right" placeholder="Total Amount" id="total_amount_id" onkeyup="CalculateRate();" required>
                                     <span class="color-pwd" id="total_amount"></span>
                                    </div>
                                    <div class="col-md-2">
                                        <span class="text-dark includeGstLabel">Including GST</span>
                                        <input type="checkbox" name="includingGst" class="form-control" placeholder="Including GST" onchange="CalculateRate();" checked>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                  <?php $__currentLoopData = $purchaseDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <tr id="product<?php echo e($list->id); ?>">
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($list->rate,2)); ?></td>
                                      <td class="align_right"><i class="fa fa-inr"></i> <?php echo e($list->taxable_value); ?></td>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($list->igst,2)); ?></td>
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($list->amount,2)); ?></td>
                                    <td>
                                      <?php if($item->apr_status == FALSE): ?>
                                      <a onclick="return confirm('Are You Sure to delete this?');" href="<?php echo e(TRADING_URL_PURCHASE.'/productItem/'.$list->id); ?>" title="Delete"><i class="fa fa-trash text-danger"></i></a>
                                      <?php else: ?>
                                  ...
                                  <tr>
                                      ...
                                      <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e($purchaseDetail->sum('taxable_value')); ?></strong></td>
                                      <td class="align_right"></td>
                                      <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e($purchaseDetail->sum('sgst')); ?></strong></td>
                                      <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e($purchaseDetail->sum('cgst')); ?></strong></td>
                                      <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e($purchaseDetail->sum('igst')); ?></strong></td>
                                      <td class="align_right"><i class="fa fa-inr"></i> <strong><?php echo e($purchaseDetail->sum('amount')); ?></strong></td>
                                      <td>&nbsp;</td>
                                  </tr>
                                </tbody>
                            </table>
                  ...
                  <?php if(count($purchaseDetail) > 0): ?>                      
                  <div class="row mb-10">
                      <div class="col-md-12 text-center">
                        <form method="post" action="<?php echo e(TRADING_URL_PURCHASE); ?>/aproved" class="form-horizontal form-label-left" >
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="product" value="<?php echo e(@$item->product_type_master_tbl->name); ?>">
                        <input type="hidden" name="party" value="<?php echo e(@$item->purchase_party_tbl->name); ?>">
                        <input type="hidden" name="date" value="<?php echo e($item->date_of_transaction); ?>">
                        <input type="hidden" name="branch" value="<?php echo e($item->branch_model_id); ?>">
                        <input type="hidden" name="taxValue" value="<?php echo e($purchaseDetail->sum('taxable_value')); ?>">
                        <input type="hidden" name="cgst" value="<?php echo e($purchaseDetail->sum('cgst')); ?>">
                        <input type="hidden" name="sgst" value="<?php echo e($purchaseDetail->sum('sgst')); ?>">
                        <input type="hidden" name="amount" value="<?php echo e($purchaseDetail->sum('amount')); ?>">
                        <input type="hidden" name="purchase_by" value="<?php echo e($item->purchase_by); ?>">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Purchase/edit.blade.php ENDPATH**/ ?>