...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo e(MASTER_URL_GROUP); ?>">
                    List
                </a>
            </li>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(MASTER_URL_GROUP.''.$item->id); ?>" id="edit_frm" class="form-horizontal form-label-left">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <option value="1" <?php echo e($item->status == 1 ? 'selected' : ''); ?>>Yes</option>
                                        <option value="0" <?php echo e($item->status == 0 ? 'selected' : ''); ?>>No</option>
                                      </select>  
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/Master/Group_Master/edit.blade.php ENDPATH**/ ?>