        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <form class="form-horizontal" action="<?php echo e(route('balance.report.page.total.loan-advancement')); ?>" method="get">
                           ...
                           <table class="table table-bordered table-hover" id="mytable_css">
                            ...
                            <?php $__currentLoopData = $_loanReport; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    $rec++;
                                    $trec++;
                                    $pageTotal += $_loan->amount;
                                ?>
                                <?php if(count($_loanReport) > 24): ?>
                                    <?php if($rec == 1): ?>
                                        <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"> <?php echo e(number_format($_loan->amount,2,'.','')); ?></td>
                                    <td>
                                        <?php
                                ...
                                <?php if($srn == 24): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align_right"><strong><?php echo e(number_format($pageTotal,2,'.','')); ?></strong></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td colspan="5"><strong>Grand Total</strong></td>
                                        <td class="align_right"><strong><?php echo e(number_format($grandTotal,2,'.','')); ?></strong></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
                                    <?php if(count($_loanReport) > $trec): ?>
                                        <tr>
                                            <td colspan="5"><strong>Previous Total</strong></td>
                                            <td class="align_right"><strong><?php echo e(number_format($grandTotal,2,'.','')); ?></strong></td>
                                            <td></td>
                                ...
                                <?php else: ?>
                                    <?php if(count($_loanReport) == $trec): ?>
                                        ...
                                        <tr>
                                            <td colspan="5"><strong>Grand Total</strong></td>
                                            <td class="align_right"><strong><?php echo e(number_format($_loanTotal,2,'.','')); ?></strong></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                    <?php endif; ?>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/BalancePageTotal/loan-advancement.blade.php ENDPATH**/ ?>