...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>RD A/c of - <?php echo e($item->open_new_ac_model->full_name); ?> A/C No. -  <?php echo e($item->account_no); ?></h1>
        <ol class="breadcrumb">
            <li>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRANSACTION_URL_RD_AC.''.$item->id.'/matured'); ?>" id="confirm_frm" class="form-horizontal form-label-left">
                    ...
                    <input type="hidden" name="ajax_url" value="<?php echo e(url('transaction/recurring-deposite/blur')); ?>" id="ajax_url">
                            <fieldset>
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-md-9">
                                        <input type="text" value="<?php echo e($item->rd_no); ?>" class="form-control" name="rd_no" readonly="">
                                      </div>
                                    </div>
                                <!-- Email input-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                      <input type="text" value="<?php echo e($item->amount); ?>" class="form-control" disabled="">
                                      </div>
                                </div>
<!-- Interest Rate (%) -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="text" value="<?php echo e($item->int_rate); ?>" class="form-control" disabled="">
                          </div>
                        </div>   
...
<!-- Period of FD -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="text" value="<?php echo e($item->period_rd); ?>" class="form-control" disabled="">
                          </div>
                        </div> 
<!-- Maturity Date -->
                        <div class="form-group">
...
<!-- Received Amount -->
                        <div class="form-group">
                          ...
                          <div class="col-md-9">
                            <input type="text" value="<?php echo e($received_amt); ?>" name="received_amount" class="form-control" readonly="">
                          </div>
                        </div>                        
<!-- Maturity Amount -->
                        <div class="form-group">
                  ...
                  <div class="panel-body" style="height: 760px;">
                      <div class="table-scrollable">
                          <table class="table table-bordered table-hover">
                              <tbody>
                                  <tr>
                                      <td ><div class="thumbnail "><img src="<?php echo e(PREFIX1.''.$item->open_new_ac_model->file); ?>" width="150" class="img-responsive"  alt=""></div></td>
                                      <td ><div class="thumbnail"><img src="<?php echo e(PREFIX1.''.$item->open_new_ac_model->signature); ?>" width="150" class="img-responsive"  alt=""></div></td>
                                  </tr>
                                </tbody>
                              </table>
                              <table class="table table-bordered table-hover">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Transaction/RD_Ac/matured.blade.php ENDPATH**/ ?>