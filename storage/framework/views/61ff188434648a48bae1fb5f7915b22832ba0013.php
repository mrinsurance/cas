                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="list-ul" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Sale List
                        </h3>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-create')): ?>
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="<?php echo e(TRADING_URL_SALE); ?>/create"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                        <?php endif; ?>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
                                ...
                                <tbody>
                                   <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <?php
                                            $amount = App\sale_detail_tbl::where('sale_tbl_id',$item->id)->sum('amount');
                                       ?>
                                  <tr id="product<?php echo e($item->id); ?>">
                                    <td><?php echo e($loop->index + 1); ?></td>
                                    <td>
                                      <a href="<?php echo e(TRADING_URL_SALE.'/'.$item->id); ?>/edit" title="Edit"><i class="fa fa-edit text-danger"></i></a>
                                      <a href="<?php echo e(TRADING_URL_SALE.'/'.$item->id); ?>" title="View"><i class="fa fa-eye text-success"></i></a>
                                      <a href="<?php echo e(route('trading.sale.print','id='.$item->id)); ?>" title="Print" target="_blank"><i class="fa fa-print text-primary"></i></a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e($amount); ?></td>
                                    <td><?php echo e($item->client); ?></td>
                                    <td><?php echo e($item->sale_by); ?></td>
                                  </tr>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Sale/list.blade.php ENDPATH**/ ?>