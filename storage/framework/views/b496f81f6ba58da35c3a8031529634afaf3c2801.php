                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            Master / Sub Group / Create
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(MASTER_URL_POST_SUB_GROUP); ?>" id="post_frm" class="form-horizontal form-label-left">
                    <?php echo e(csrf_field()); ?>
                            ...
                            <fieldset>
                                ...
                                <!-- Message body -->
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="message">Balance Sheet Head</label>
                                    <div class="col-md-9">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbara/resources/views/Master/SubGroup_Master/create.blade.php ENDPATH**/ ?>