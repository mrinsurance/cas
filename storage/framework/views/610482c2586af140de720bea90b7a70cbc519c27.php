        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="list" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Balance Report of Bank FD A/C (Interest By Day)
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo e(BALANCE_REPORT_URL_BANK_FD_BY_DAY); ?>" method="get">
                    ...
                    <div class="table-scrollable">
                        ...
                        <div class="prnt" id="record">
                           ...
                           <table class="table table-bordered table-hover" id="mytable_css">
                            <thead>
                                <tr>
                                    <td colspan="<?php echo e(isset(request()->bank) ? 8 : 9); ?>">
...
<?php
$IntrDif = $item->maturity_amount - $item->amount;

$MDate = \Carbon\Carbon::createFromFormat('Y-m-d', $item->maturity_date);
$RDate = \Carbon\Carbon::createFromFormat('Y-m-d', $item->int_run_from);
$DayDiff = $MDate->diffInDays($RDate);

$IntrOneDay = ($IntrDif / $DayDiff);
...
$intr = round($IntrOneDay * $diff_in_days);
?>
                                ...
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($item->amount,2)); ?></td>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($item->maturity_amount,2)); ?></td>
                                </tr>
                                <?php
                                ...
                                <tr>
                                    ...
                                    <th></th>
                                    <th class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($MatAmt,2)); ?></th>
                                </tr>
                            </tbody>
                        </table>
                        </div>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbatran.himachalsociety.com/resources/views/Balance/by-day-bank-fd-balance.blade.php ENDPATH**/ ?>