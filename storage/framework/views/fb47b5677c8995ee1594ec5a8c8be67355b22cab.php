        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo e(AUDIT_REPORT_URL_TRADING_PL); ?>" method="get">
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($mHeadAmt,2)); ?></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    <td>CLOSING STOCK</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($closingStock,2)); ?></td>
                                                </tr>
                                                <?php if($drTotal > $crTotal): ?>
                                                <?php $gl = ($drTotal - $crTotal); ?>
                                                <tr>
                                                    <td><strong>GROSS LOSS</strong></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($gl,2)); ?></td>
                                                </tr>
                                                <?php endif; ?>
                                    ...
                                    <td colspan="2">
                                        <table  class="table table-bordered table-hover" id="mytable_css">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>OPENING STOCK</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($openingStock,2)); ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($gp,2)); ?></td>
                                                </tr>
                                                <?php endif; ?>                                                
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <?php if($drTotal > $crTotal): ?>
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($crTotal + ($drTotal - $crTotal),2)); ?></td>
                                    <?php else: ?>
                                        <td class="text-right"  colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($crTotal,2)); ?></td>
                                    <?php endif; ?>

                                    <?php if($crTotal > $drTotal): ?>
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($drTotal + ($crTotal - $drTotal),2)); ?></td>
                                    <?php else: ?>
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($drTotal,2)); ?></td>
                                    <?php endif; ?>  
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <!-- Print view                         -->
                           ...
                           <table width="60%" class="table table-bordered table-hover" id="mytable_css">
                            ...
                            <tbody>
                                        ...
                                        <table width="60%"  class="table table-bordered table-hover" id="mytable_css">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo e(($drList->main_head)); ?></td>
                                                    <td></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($plmHeadAmt,2)); ?></td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                               ...
                                               <tr>
                                                    ...
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($intrLoan,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo e(("INTEREST RECOVERABLE ON BANK FD")); ?></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($intrBankFd,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo e(("INTEREST RECOVERABLE ON BANK RD")); ?></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($intrBankRd,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                
                                                <tr>
                                                    <td><?php echo e(("INTEREST PAYABLE LBS")); ?></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($lbsplcrTotal,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td><strong><?php echo e(("INTEREST RECEIVED")); ?></strong></td>
                                                    <td>&nbsp;</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format(($intrRec),2)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>NPA LBS</td>
                                                    <td>&nbsp;</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($lbsNpa,2)); ?></td>
                                                    
                                                </tr>
                                                <?php if($pldrTotal > $plcrTotal): ?>
                                                <tr>
                                                    <td><strong>NET LOSS</strong></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format(($pldrTotal - $plcrTotal),2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <?php endif; ?>
                                        ...
                                        <table  class="table table-bordered table-hover" id="mytable_css">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($intrFd,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo e(("INTEREST PAYBLE ON RD")); ?></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($intrRd,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td><?php echo e(("INTEREST RECOVERABLE LBS")); ?></td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($lbspldrTotal,2)); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td><strong>INTEREST PAID</strong></td>
                                                    <td>&nbsp;</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format(($intrPaid),2)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>NPA AMOUNT</td>
                                                    <td>&nbsp;</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($npaAmt,2)); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>NPA INTEREST</td>
                                                    <td>&nbsp;</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($npaIntr,2)); ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&nbsp;</td>
                                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format(($plcrTotal - $pldrTotal),2)); ?></td>
                                                </tr>
                                                <?php endif; ?>                                                
                                            </tbody>
                                        </table>
                                ...
                                <tr>
                                    <?php if($pldrTotal > $plcrTotal): ?>
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($plcrTotal + ($pldrTotal - $plcrTotal),2)); ?></td>
                                    <?php else: ?>
                                        <td class="text-right"  colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($plcrTotal,2)); ?></td>
                                    <?php endif; ?>

                                    <?php if($plcrTotal > $pldrTotal): ?>
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($pldrTotal + ($plcrTotal - $pldrTotal),2)); ?></td>
                                    <?php else: ?>
                                        <td class="text-right" colspan="2"><strong class="ml-55">TOTAL:</strong> <i class="fa fa-inr"></i> <?php echo e(number_format($pldrTotal,2)); ?></td>
                                    <?php endif; ?>  
                                </tr>
                            </tbody>
                        </table>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Audit//trading_pl_report.blade.php ENDPATH**/ ?>