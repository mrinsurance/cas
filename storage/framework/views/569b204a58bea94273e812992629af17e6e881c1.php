...
<?php $__env->startPush('extra_js'); ?>
  ...
  <script src="<?php echo e(ASSETS_JS); ?>bank-fixed-deposit.js"></script></script>
<?php $__env->stopPush(); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <form method="post" action="<?php echo e(TRANSACTION_URL_BANK_FD_AC.''.$item->id); ?>" id="edit_frm" class="form-horizontal form-label-left">
                            ...
                            <fieldset>
                              <!-- Name input-->
                                    ...
                                    <div class="col-md-8">
                                      <select name="branch" class="form-control">
                                          <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($val->id); ?>" <?php echo e($val->id == $item->branch_model_id ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                                    ...
                                    <div class="col-md-8">
                                      <select name="bank" class="form-control">
                                          <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($val->id); ?>" <?php echo e($val->id == $item->bank_model_id ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" name="account_no" value="<?php echo e($item->account_no); ?>" class="form-control ac_no">
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-md-8">
                                        <input type="text" name="fd_no" value="<?php echo e($item->fd_no); ?>" class="form-control">
                                      </div>
                                    </div>
                                <!-- Email input-->
                                <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <select name="type_of_deposit" class="form-control">
                                ...
                                <option value="<?php echo e($val); ?>" <?php echo e($val == $item->type_of_deposite ? 'selected' : ''); ?>><?php echo e($val); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                            </select>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Transaction/Bank_FD_Ac/edit.blade.php ENDPATH**/ ?>