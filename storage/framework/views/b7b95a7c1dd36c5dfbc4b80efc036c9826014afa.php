...
<?php $__env->startPush('extra_js'); ?>
  ...
  <script src="<?php echo e(ASSETS_JS); ?>loan_ac_recover.js"></script>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRANSACTION_URL_POST_LOAN_AC.'/recover_payment'); ?>" id="post_frm" class="form-horizontal form-label-left">
                    ...
                    <input type="hidden" name="loan_type_url" id="loan_type_url" value="<?php echo e(url('transaction/loan/recovery')); ?>">
                    ...
                    <input type="hidden" id="rec_date_url" value="<?php echo e(url('transaction/loan/'.$item->id.'/'.$item->token.'/recovery')); ?>">
                    <input type="hidden" name="loan_ac_model" value="<?php echo e($item->id); ?>">
                    <input type="hidden" name="member_type_model" value="<?php echo e($item->member_type_model_id); ?>">
                    <input type="hidden" name="account_no" value="<?php echo e($item->account_no); ?>">
                    <input type="hidden" name="loan_type" value="<?php echo e($loan_type->name); ?>">
                    <span id="loop_input"></span>
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="date" name="receiving_date" class="form-control" id="date1_receiving" value="<?php echo e(old(date('Y-m-d'),$rec_date)); ?>">
                                      <!-- <input type="text" name="receiving_date" class="form-control" id="date_receiving" value="<?php echo e(old(date('Y-m-d'),$rec_date)); ?>" readonly="readonly"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" name="pending_interest" class="form-control pending_interest" value="<?php echo e(@$loan_returns_last->pending_intr ? $loan_returns_last->pending_intr : 0); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                      Interest
                                      <input type="text" class="form-control interest_recover" name="interest_recover"  value="<?php echo e(round($total_recoverable_int) + round($total_add_int)); ?>">
                                      <span class="color-pwd" id="interest_recover"></span>

                                        <!-- <label class="col-md-4 control-label" for="password">Hidden Intereset</label> -->
                                        <input type="hidden" class="int_recover" name="int_recover" value="<?php echo e(round($total_recoverable_int)); ?>">

                                        <!-- <label class="col-md-4 control-label" for="password">Hidden Additional Int</label> -->
                                        <input type="hidden" class="add_recover" name="add_recover" value="<?php echo e(round($total_add_int)); ?>">

                                      <?php if(@$loan_returns_last->pending_intr): ?>
                                        <?php $pending_int = @$loan_returns_last->pending_intr + (round($total_recoverable_int) + round($total_add_int)); ?>
                                      <?php else: ?>
                                      <?php $pending_int =  0 + (round($total_recoverable_int) + round($total_add_int)); ?>
                                      <?php endif; ?>
                                    </div>
                                    <div class="col-md-4">
                                      Principal
                                      <input type="text" class="form-control principal_recover" name="principal_recover" value="<?php echo e($item->amount - $total_received_amt); ?>" readonly>
                                      <?php $pr = ($item->amount - $total_received_amt); ?>
                                ...
                                <div class="form-group hidden" id="saving_account_balance">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="saving_account_balance" class="form-control" value="<?php echo e($saving_balance); ?>" disabled>
                                        <input type="hidden" name="is_sufficiante_balnce" value="<?php echo e($is_sufficiante_balnce); ?>">
                                    </div>
                                </div>
                                <!-- Email input-->
                                <div class="form-group">
                      ...
                      <div class="table-scrollable" style="overflow-y:auto; height: 323px;" id="togle_table">
                          <table class="table table-bordered table-hover">
                              <tbody>
                                  ...
                                  <tbody id="userTable">
<?php $n = 0; ?>
                                    <?php $__currentLoopData = $loan_installments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
...
?>
                                      <tr>
                                        ...
                                        <td><?php echo e($val->installment_date); ?></td>
                                        <td><?php echo e($diff_in_days); ?></td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($val->principal)); ?>

                                        </td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($val->received_principal)); ?></td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($val->principal - $val->received_principal)); ?></td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($cint + $aint,2)); ?></td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($cint)); ?></td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($aint)); ?></td>
                                        <td>
                                          <i class="fa fa-inr"></i> <?php echo e(number_format($val->received_principal)); ?></td>
                                      </tr>
...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover"  style="width: 100% !important;">
        ...
        <tbody>
          <?php $i = 1; $ct = count($loan_returns); ?>
          <?php $__currentLoopData = $loan_returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <input type="hidden" id="prd_id" value="<?php echo e($val->id); ?>">
          <tr id="product<?php echo e($val->id); ?>">
                <td><?php echo e($loop->index + 1); ?></td>
                <td><?php echo e($val->received_date); ?></td>
                <td><?php echo e($val->received_principal); ?></td>
                <td><?php echo e($val->received_interest); ?></td>
                <td>

                    <?php if(!$CheckLock): ?>
                  <button type="button" title="Delete"  class="btn btn-danger  delete-product" value="<?php echo e(url(TRANSACTION_URL_LOAN_AC.'recover_payment/'.$val->id.'/'.$item->id.'/'.$val->received_date)); ?>">
...
?>
    ...
    <tbody>
        ...
        <tr>
          <th>Loan Type</th>
            <td><?php echo e($loan_type->name); ?></td>
        </tr>
        <tr>
          <th>Period</th>
            <td>Term - (<?php echo e($item->term); ?>) & Months - (<?php echo e($item->months); ?>)</td>
        </tr>
        <tr>
          <th>Interest %</th>
            <td>Interest @% - (<?php echo e($item->interest); ?>) & Pannelty Interest - (<?php echo e($item->pannelty_int); ?>)</td>
        </tr>
        <tr>
          <th>Type of Interest</th>
            <td><?php echo e($item->type_of_interest); ?></td>
        </tr>
        <!-- <tr>
          <th>Loan Purpose</th>
            <td><?php echo e($item->loan_purpose); ?></td>
        </tr> -->
        <tr>
        ...
        <tr>
          <th>Amount</th>
            <td><i class="fa fa-inr"></i> <strong><?php echo e(number_format($item->amount)); ?></strong></td>
        </tr>
        <tr>
          <th>Installment Amt</th>
            <td><i class="fa fa-inr"></i> <strong><?php echo e(number_format($item->inst_amt)); ?></strong></td>
        </tr>
        <?php if($one): ?>
        <tr>
          <th>Guarantor One</th>
            <td>A/C No. - <?php echo e($gaurnter_one->account_no); ?> (<?php echo e($gaurnter_one->full_name); ?>)</td>
        </tr>
        <?php endif; ?>
        <?php if($two): ?>
        <tr>
          <th>Guarantor Two</th>
            <td>A/C No. - <?php echo e($gaurnter_two->account_no); ?> (<?php echo e($gaurnter_two->full_name); ?>)</td>
        </tr>
        <?php endif; ?>
        <tr>
          <td><a class="btn btn-success btn_sizes" target="_blank" href="<?php echo e(asset(TRANSACTION_URL_LOAN_AC.'notice/'.$item->id.'/'.old(date('Y-m-d'),$rec_date)).'/'.$pending_int.'/'.$pr.'/'.$item->date_of_advance); ?>?page=notice"><i class="fa fa-print" aria-hidden="true"></i> Notice</a>
            <a class="btn btn-primary btn_sizes" target="_blank" href="<?php echo e(asset(TRANSACTION_URL_LOAN_AC.'notice/'.$item->id.'/'.old(date('Y-m-d'),$rec_date)).'/'.$pending_int.'/'.$pr.'/'.$item->date_of_advance); ?>?page=election"><i class="fa fa-print" aria-hidden="true"></i> Notice Election</a></td>
          <td><a class="btn btn-success btn_sizes" target="_blank" href="<?php echo e(asset(LEDGER_REPORT_URL_PERSONAL_LEDGER.'?_token=4eLSx7hR0YeCoXDlJtgE7fmwvKLcT7oky9c5qi8S&from_date='.date('Y-m-d').'&to_date='.date('Y-m-d').'&member_type='.$item->member_type_model_id.'&account='.$item->account_no)); ?>"> P/L View </a>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form method="post" action="<?php echo e(TRANSACTION_URL_POST_LOAN_AC.'-gaurntor/'.$item->id); ?>" id="edit_frm" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>
          ...
          <div class="form-group">
              ...
              <div class="col-md-8">
                <select name="guarantor_one" class="form-control">
                  ...
                  <option value="<?php echo e($val->id); ?>" <?php echo e($item->guarnter_one == $val->id ? 'selected' : ''); ?>><?php echo e($val->account_no); ?> - <?php echo e($val->full_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <select name="guarantor_two" class="form-control">
                  <option value="">--- Select ---</option>
                  <?php $__currentLoopData = $guarenter_first; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($val->id); ?>" <?php echo e($item->guarnter_two == $val->id ? 'selected' : ''); ?>><?php echo e($val->account_no); ?> - <?php echo e($val->full_name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
          ...
          <div class="form-group">
              ...
              <div class="col-md-8">
                <select name="loan_purpose" class="form-control">
                  ...
                  <option value="<?php echo e($val->id); ?>" <?php echo e($item->loan_purpose == $val->id ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
      ...
      <div class="modal-footer">
        <input type="hidden" value="<?php echo e(URL::current()); ?>" name="pageurl">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Transaction/LOAN_Ac/recovery.blade.php ENDPATH**/ ?>