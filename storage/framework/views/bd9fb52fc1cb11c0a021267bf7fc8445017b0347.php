...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>Saving A/c List - <?php echo e($profile->member_type_model->name); ?> A/C No. -  <?php echo e($profile->account_no); ?> (<?php echo e($profile->full_name); ?>)</h1>
        <ol class="breadcrumb">
            <li>
                                    ...
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr id="product<?php echo e($item->id); ?>">
                                        ...
                                        <td>
                                          ...
                                          <a href="<?php echo e(TRANSACTION_URL_SAVING_AC.''.$item->id); ?>/edit" class="btn btn-warning btn-sm" title="Edit"><i class="fa fa-edit"></i></a>

                                          <?php endif; ?>
                                          <a href="<?php echo e(TRANSACTION_URL_SAVING_AC.''.$item->id); ?>/print" target="_blank" class="btn btn-success btn_sizes" title="Print"><i class="fa fa-fw fa-print"></i></a>
                                            <?php endif; ?>
                                        </td>
                                        <td>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Transaction/Saving_Ac/transaction-list.blade.php ENDPATH**/ ?>