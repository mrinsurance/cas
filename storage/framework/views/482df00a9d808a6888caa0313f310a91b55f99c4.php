                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="<?php echo e(TRANSACTION_URL_DRD_AC); ?>create"><i class="fa fa-plus-circle"></i> Create New DRD</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                  ...
                                  <tr id="product<?php echo e($item->id); ?>">
                                    ...
                                    <td>
                                        <?php if(!$CheckLock): ?>
                                            <?php if($item->status == 1): ?>
                                            <a href="<?php echo e(TRANSACTION_URL_DRD_AC.''.$item->id); ?>/edit" class="btn btn-warning btn-sm" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo e(TRANSACTION_URL_DRD_AC.'installment/'.$item->id.'/'.$item->token); ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" title="Installment"><i class="fa fa-ticket"></i></a>
                                            <a href="<?php echo e(TRANSACTION_URL_DRD_AC.''.$item->id); ?>/matured" class="btn btn-danger btn-sm" data-toggle="tooltip" title="Mature">
                                                <i class="fa fa-arrow-right"></i>
                                            </a>
                                            <?php else: ?>
                                            <a href="<?php echo e(TRANSACTION_URL_DRD_AC.''.$item->id); ?>" class="btn btn-primary btn-sm" data-toggle="tooltip" title="View"><i class="fa fa-eye"></i></a>
                                                <a href="<?php echo e(TRANSACTION_URL_DRD_AC.''.$item->id); ?>/matured" class="btn btn-success btn-sm" data-toggle="tooltip" title="UnMature">
                                                <i class="fa fa-arrow-right"></i>
                                                </a>
                                            <?php endif; ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbatran.himachalsociety.com/resources/views/Transaction/DRD_Ac/list.blade.php ENDPATH**/ ?>