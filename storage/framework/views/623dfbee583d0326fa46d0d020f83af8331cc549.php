                ...
                <div class="portlet-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <?php $__currentLoopData = $productList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo e(request()->get('product_name') == $list->id ? $list->name : ''); ?>
...
<table class="table table-bordered table-hover" id="mytable_css">
    ...
    <tbody>
        <tr>
            ...
            <td>Opening Stock</td>
            <td class="text-right"> <?php echo e(number_format($sumOfOpenQuantity,3)); ?></td>
            <td>0</td>
            <td colspan="4"></td>
            <td class="text-right"> <?php echo e(number_format($sumOfOpenQuantity,3)); ?></td>
        </tr>
        ...
        <?php $__currentLoopData = $ledgerDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td class="text-right">0</td>
                <td class="text-right">0</td>
                <td class="text-right"><?php echo e(number_format($list->purchase_quantity,3) ?? 0); ?></td>
                <td class="text-right"><?php echo e(number_format($list->purchase_amount,2) ?? 0.00); ?></td>
                <td class="text-right"><?php echo e(number_format($list->sale_quantity,3) ?? 0); ?></td>
                <td class="text-right"><?php echo e(number_format($list->sale_amount,2) ?? 0.00); ?></td>
                <td class="text-right"><?php echo e(number_format($balanceQty,3)); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
</table>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/item-ledger/index.blade.php ENDPATH**/ ?>