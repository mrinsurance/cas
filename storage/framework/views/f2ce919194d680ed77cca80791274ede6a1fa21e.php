                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Trading / Products
                        </h3>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-create')): ?>
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="<?php echo e(TRADING_URL_PRODUCTS); ?>/create"><i class="fa fa-plus-circle"></i> Add New</a>
                        </div>
                        <?php endif; ?>
                    </div>
                                ...
                                <tbody>
                                   <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr id="product<?php echo e($item->id); ?>">
                                        ...
                                        <td><?php echo e($item->purchase_rate); ?></td>
                                        <td><?php echo e($item->sale_rate); ?></td>
                                        <td><?php echo e(@$item->tax_master_tbl->name); ?></td>
                                        <td><?php echo e(@$item->product_type_master_tbl->name); ?></td>
                                        <td>
                                            <a href="<?php echo e(TRADING_URL_PRODUCTS.'/'.$item->id.'/edit'); ?>" title="Edit"  class="btn btn-success">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger delete-product" value="<?php echo e(TRADING_URL_PRODUCTS.'/'.$item->id); ?>" title="Delete"><i class="fa fa-trash"></i> </button>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Products/list.blade.php ENDPATH**/ ?>