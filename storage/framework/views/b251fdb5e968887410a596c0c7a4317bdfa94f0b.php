...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo e(MASTER_URL_LOAN_PURPOSE); ?>">
                    List
                </a>
            </li>
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            Master / Loan Purpose / Create
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(MASTER_URL_POST_LOAN_PURPOSE); ?>" id="post_frm" class="form-horizontal form-label-left">
                    <?php echo e(csrf_field()); ?>

                            <fieldset>
                                <!-- Message body -->
                                <div class="form-group">
                                    <label class="col-md-3 control-label" for="message">Loan Purpose</label>
                                    <div class="col-md-9">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Master/Loan_Purpose/create.blade.php ENDPATH**/ ?>