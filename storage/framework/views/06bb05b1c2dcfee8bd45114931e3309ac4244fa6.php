            ...
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRADING_URL_PRODUCTS.'/'.$item->id); ?>" id="edit_frm" class="form-horizontal form-label-left">
  ...
  <?php echo e(method_field('PUT')); ?>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="text" name="purchase_rate" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e($item->purchase_rate); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="text" name="sale_rate" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e($item->sale_rate); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                       <input type="text" name="hsn" class="form-control col-md-7 col-xs-12" value="<?php echo e($item->hsn); ?>">
                                    ...
                                    <div class="col-md-9">
                                        <select name="product_type" class="form-control" required>
                                            ...
                                            <?php $__currentLoopData = $prd_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($list->id); ?>" <?php echo e($list->id == $item->product_type_master_tbl_id ? 'selected' : ''); ?>><?php echo e($list->name); ?></option>
                                    ...
                                    <div class="col-md-9">
                                        <select name="unit" class="form-control" required>
                                            ...
                                            <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($list->id); ?>" <?php echo e($list->id == $item->unit_master_tbl_id ? 'selected' : ''); ?>><?php echo e($list->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                        </select>
                                    ...
                                    <div class="col-md-9">
                                        <select name="tax" class="form-control" required>
                                            ...
                                            <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($list->id); ?>" <?php echo e($list->id == $item->tax_master_tbl_id ? 'selected' : ''); ?>><?php echo e($list->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                        </select>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Trading/Products/edit.blade.php ENDPATH**/ ?>