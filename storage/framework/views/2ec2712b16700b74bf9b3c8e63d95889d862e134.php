            ...
            <ul class="page-sidebar-menu" id="menu">
                    ...
                    <?php if(!Auth::user()->hasAnyRole(['AGENT'])): ?>
                        <li class="<?php if(Request::is('transaction/new-account*')): ?> active <?php endif; ?>"><a href="#"> <i class="fa fa-angle-double-right"></i> A/C Holders</a>
                            <ul class="sub-menu">
                                ...
                                <li class="<?php if(Request::is('transaction/agent-permission*')): ?> active <?php endif; ?>">
                                    <a href="<?php echo e(route('agent-permission')); ?>" >
                                        <i class="fa fa-angle-double-right"></i>
                                        Agent Permission
                                    </a>
                                </li>
                ...
                <li class="<?php if(Request::is('ledger-report*')): ?> active <?php endif; ?>">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="<?php if(Request::is('ledger-report/fd-ledger*')): ?> active <?php endif; ?>"><a href="<?php echo e(route('ledger.fd-ledger')); ?>"> <i class="fa fa-angle-double-right"></i> FD Ledger</a></li>
                        <li class="<?php if(Request::is('ledger-report/print-fd-ledger*')): ?> active <?php endif; ?>"><a href="<?php echo e(route('ledger.print-fd-ledger')); ?>"> <i class="fa fa-angle-double-right"></i> Print FD Ledger</a></li>
...
<?php /**PATH /home/l0t4shykdrn8/public_html/casbatran.himachalsociety.com/resources/views/mylayout/sidebar.blade.php ENDPATH**/ ?>