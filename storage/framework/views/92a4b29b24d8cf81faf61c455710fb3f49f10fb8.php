...
<aside class="right-side strech">
    ...
    <section class="content-header">
        <!--section starts-->
        <h1>Saving A/c of - <?php echo e(@$item->member_type_model->name); ?> A/C No. -  <?php echo e($item->account_no); ?> (<?php echo e(@$item->open_new_ac_model->full_name); ?>)</h1>
        <ol class="breadcrumb">
            <li>
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-primary" id="hidepanel2">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(TRANSACTION_URL_SAVING_AC.''.$item->id); ?>" id="edit_frm" class="form-horizontal form-label-left">
                    ...
                    <?php echo e(method_field('PATCH')); ?>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <select name="member_type" class="form-control col-md-7 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" name="account_no" value="<?php echo e($item->account_no); ?>" class="form-control ac_no" readonly>
                                      </div>
                                </div>
                                <!-- Email input-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <input type="text" value="<?php echo e($item->amount); ?>" name="amount" class="form-control col-md-7 col-xs-12 amount groupOfTexbox" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                      <!-- <input type="text" value="<?php echo e($item->date_of_transaction); ?>" name="date_of_transaction" class="form-control col-md-7 col-xs-12" id="transaction_date" value="<?php echo e(date('Y-m-d')); ?>" readonly="readonly"> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <label class="radio-inline">
                                        &nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                          <input type="radio" name="mode_of_transaction" value="Transfer" <?php echo e($item->mode_of_transaction == 'Transfer' ? 'checked' : ''); ?>>Transfer
                                      </label>
                                        ...
                                        <div class="col-md-8">
                                            <select name="subGroups" class="form-control">
                                                <?php $__currentLoopData = subGroupsMaster(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($val->name); ?>" <?php echo e($item->sub_group == $val->name ? 'selected' : ''); ?>><?php echo e($val->name); ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <textarea name="transaction_particular" class="form-control col-md-7 col-xs-12" cols="30" rows="1" id="trans_particular"><?php echo e($item->particular == '' ? 'Deposit by Cash' : $item->particular); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                       <textarea name="remarks" class="form-control col-md-7 col-xs-12" cols="30" rows="1"><?php echo e($item->remarks); ?></textarea>
                                  ...
                                  <tr>
                                      <td>
                                          <div id="preview" class="thumbnail">
                                              <img src="<?php echo e(PREFIX1.''.@$item->open_new_ac_model->file); ?>" width="100" alt="">
                                          </div>
                                          <div id="sign" class="thumbnail">
                                              <img src="<?php echo e(PREFIX1.''.@$item->open_new_ac_model->signature); ?>" width="100" alt="">
                                          </div>
                                      </td>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Transaction/Saving_Ac/edit.blade.php ENDPATH**/ ?>