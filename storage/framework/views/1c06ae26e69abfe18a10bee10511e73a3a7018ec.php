...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Purchase Party</li>
        </ol>
    </section>
    <!--section ends-->
                ...
                <div class="portlet box primary">
                    <div class="panel-heading portlet-title">
                        <h3 class="panel-title pull-left add_remove_title">
                            <i class="livicon" data-name="bell" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Master / Purchase Party
                        </h3>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-create')): ?>
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="<?php echo e(MASTER_URL_PURCHASE_PARTY); ?>/create"><i class="fa fa-plus-circle"></i> Add New</a>
                        </div>
                        <?php endif; ?>
                    </div>
                                ...
                                <tbody>
                                   <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <tr id="product<?php echo e($item->id); ?>">
                                        ...
                                        <td>
                                            <a href="<?php echo e(MASTER_URL_PURCHASE_PARTY.'/'.$item->id.'/edit'); ?>" title="Edit"  class="btn btn-success">
                                                <i class="fa fa-pencil"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger delete-product" value="<?php echo e(MASTER_URL_PURCHASE_PARTY.'/'.$item->id); ?>" title="Delete"><i class="fa fa-trash"></i> </button>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casgahallian/resources/views/Master/Purchase-Party/list.blade.php ENDPATH**/ ?>