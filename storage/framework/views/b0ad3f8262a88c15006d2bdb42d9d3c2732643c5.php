                ...
                <div class="panel panel-primary" id="hidepanel1">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            ...
                            Master / Sale Party / Create
                        </h3>
                    </div>
                    <div class="panel-body">
                        <form method="post" action="<?php echo e(route('master.sale.party.submit')); ?>" id="post_frm" class="form-horizontal form-label-left">
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u574406823/domains/himachalsociety.com/public_html/casbatran/resources/views/Master/Sale-Party/create.blade.php ENDPATH**/ ?>