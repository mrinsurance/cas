        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                ...
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo e(url('balance-report/saving-paginate')); ?>" method="get">
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                
                                                Saving Balance Report as on <?php echo e(date('d-M-Y',strtotime($from_date))); ?>
                        ...
                        <?php if(isset($_REQUEST['_token'])): ?>
                                <div style="float: right;margin-right:10px"><?php echo e(@($_REQUEST['from_date'])?$ac_holders->appends(['_token' => $_REQUEST['_token'],'branch' => $_REQUEST['branch'],'from_date' => $_REQUEST['from_date'],'member_type' => $_REQUEST['member_type'],'paginate_total_grand'=>@$paginate_total_grand])->render():''); ?></div>
                         <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbara.himachalsociety.com/resources/views/Balance/saving_balance_paginate.blade.php ENDPATH**/ ?>