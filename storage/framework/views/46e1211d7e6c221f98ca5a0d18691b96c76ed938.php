...
<aside class="right-side strech">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">DRD Balance</li>
        </ol>
    </section>
    <!--section ends-->
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box primary">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="livicon" data-name="list" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Balance Report of DRD A/C
                    </div>
                </div>
                <div class="portlet-body">
                    <div class="row">
                    <div class="col-md-12">
                    <form class="form-horizontal" action="<?php echo e(BALANCE_REPORT_URL_DRD); ?>" method="get">
...
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                                                
                                                DRD Balance Report as on <?php echo e(date('d-M-Y',strtotime($from_date))); ?>
                            ...
                            <tbody>
                                ...
                                <?php
                                $totall = \App\drd_installment_model::where('drd_model_id',$item->id)->sum('amount');
                                ?>
                                <tr>
                                    ...
                                    <td class="align_right"><i class="fa fa-inr"></i> <?php echo e(number_format($totall,2)); ?></td>
...
<?php echo $__env->make('mylayout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/l0t4shykdrn8/public_html/casbara.himachalsociety.com/resources/views/Balance/drd_balance.blade.php ENDPATH**/ ?>