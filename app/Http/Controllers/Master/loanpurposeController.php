...
class loanpurposeController extends Controller
{
    ...
    {
        $items = loanpurpose_model::orderBy('name','asc')->get();
        return view(MASTER_LOAN_PURPOSE.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_LOAN_PURPOSE."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_LOAN_PURPOSE);
    ...
    {
        $item = loanpurpose_model::find($id);
        // dd($roles);
        return view(MASTER_LOAN_PURPOSE.'edit', compact(['item']));
    }
