...
class balsheetheadController extends Controller
{
    /**
    ...
    {
        $items = bal_sheet_head_model::orderBy('name','asc')->get();
        return view(MASTER_BAL_SHEET_HEAD_MASTER.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_BAL_SHEET_HEAD_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_BAL_SHEET_HEAD);
    ...
    {
        $item = bal_sheet_head_model::find($id);
        // dd($roles);
        return view(MASTER_BAL_SHEET_HEAD_MASTER.'edit', compact(['item']));
    }
