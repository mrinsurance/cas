...
class sessionController extends Controller
{
    ...
    {
        $items = session_master_model::orderBy('start_date','asc')->get();
        return view(MASTER_SESSION_MASTER.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_SESSION_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_SESSION);
    ...
    {
        $item = session_master_model::find($id);
        // dd($roles);
        return view(MASTER_SESSION_MASTER.'edit', compact(['item']));
    }
*/
    /**
