...
use App\ration_depot_model;
use Auth;
use DB;
use Response;

class rationdepotController extends Controller
{
    /**
    ...
    {
        $items = ration_depot_model::orderBy('name','asc')->get();
        return view(MASTER_RATION_DEPOT.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_RATION_DEPOT."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_RATION_DEPOT);
    ...
    {
        $item = ration_depot_model::find($id);
        // dd($roles);
        return view(MASTER_RATION_DEPOT.'edit', compact(['item']));
    }
