...
class bankController extends Controller
{
    ...
    {
        $items = bank_model::orderBy('name','asc')->get();
        return view(MASTER_BANK_MASTER.'list',compact(['items']));
    }
    ...
    {
       return view(MASTER_BANK_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_BANK);
    ...
    {
        $item = bank_model::find($id);
        // dd($roles);
        return view(MASTER_BANK_MASTER.'edit', compact(['item']));
    }
