...
class unitController extends Controller
{
    ...
    {
        $items = unit_master_tbl::orderBy('name','asc')->get();
        return view(MASTER_UNIT_MASTER.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_UNIT_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            $item = new unit_master_tbl();
            
                $item->name = $request->name;
                $item->save();    
           
            $return_url = url(MASTER_URL_UNIT);
    ...
    {
        $item = unit_master_tbl::find($id);
        // dd($roles);
        return view(MASTER_UNIT_MASTER.'edit', compact(['item']));
    }
