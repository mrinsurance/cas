...
class designationController extends Controller
{
    ...
    {
        $items = designation_model::orderBy('name','asc')->get();
        return view(MASTER_DESIGNATION_MASTER.'list',compact(['items']));
    }
    ...
    {
       return view(MASTER_DESIGNATION_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_DESIGNATION);
    ...
    public function edit($id)
    {
        ...
        // dd($roles);
        return view(MASTER_DESIGNATION_MASTER.'edit', compact(['item']));
    }
