...
use App\product_type_master_tbls;
...
class productTypeController extends Controller
{
    ...
    {
        $items = product_type_master_tbl::orderBy('name','asc')->get();
        return view(MASTER_PRODUCT_TYPE_MASTER.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_PRODUCT_TYPE_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            $item = new product_type_master_tbl();
            
                $item->name = $request->name;
                $item->save();    
           
            $return_url = url(MASTER_URL_PRODUCT_TYPE);
    ...
    {
        $item = product_type_master_tbl::find($id);
        // dd($roles);
        return view(MASTER_PRODUCT_TYPE_MASTER.'edit', compact(['item']));
    }
