...
class branchController extends Controller
{
    ...
    {
        $items = branch_model::orderBy('name','asc')->get();
        return view(MASTER_BRANCH_MASTER.'list',compact(['items']));
    }
    ...
    {
        return view(MASTER_BRANCH_MASTER."create");
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $return_url = url(MASTER_URL_BRANCH);
    ...
    {
        $item = branch_model::find($id);
        // dd($roles);
        return view(MASTER_BRANCH_MASTER.'edit', compact(['item']));
    }
