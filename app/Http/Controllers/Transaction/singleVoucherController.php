...
class singleVoucherController extends Controller
{
   /**
    ...
    public function index()
    {
        ...
        return view(TRANSACTION_VOUCHER_SINGLE.'list')->with($data);
    }
    ...
    public function create()
    {
        ...
        return view(TRANSACTION_VOUCHER_SINGLE."create")->with($data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            $item->amount = $request->total_debit;
...
// Start Voucher TBL Ledger table entry detail                
                ...
                $return_url = url(TRANSACTION_URL_VOUCHER_SINGLE);
    ...
    public function show($id)
    {
        ...
        return view(TRANSACTION_VOUCHER_SINGLE.'view')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return view(TRANSACTION_VOUCHER_SINGLE.'edit')->with($data);
    }
